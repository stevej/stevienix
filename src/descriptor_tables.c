...
static void gdt_set_gate(i32, u8, u32, u8, u8);
...
static void gdt_set_gate(i32 num, u8 base, u32 limit, u8 access, u8 gran) {
...
static void write_tss(i32 num, u16 ss0, u32 esp0) {
...
static void init_idt() {
  ...
  idt_set_gate(128, (u32)isr128, 0x08, 0x8E); // for syscalls
