...
Jim Boemler (jboemler@halcyon.com)
  ...
  This header created on Mon Nov 18 14:16:01 PST 2013
...
PCI_VENTABLE PciVenTable[] = {
    ...
    {0x0402, "PCI\\VEN_10EC&DEV_5209&SUBSYS_05901025&REV_01",
     " Acer aspire one"},
    {0x046D, " ", "Logitech Inc."},
    {0x0483, "UPEK", "UPEK"},
    ...
    {0x0AC8, "ASUS ", "ASUS "},
    {0x0b05, "Toshiba BT-183 bluetooth 2.0",
     "Toshiba Bluetooth RFBUS, RFCOM, RFHID"},
    ...
    {0x10F0, "Real-Time Graphics & Video",
    ...
    {0x1B91, "", "Averna"},
    {0x1BAD, " ", "ReFLEX CES"},
    {0x1C0F, "Monarch Innovative Technologies ",
     "Monarch Innovative Technologies Pvt Ltd's "},
...
PCI_DEVTABLE PciDevTable[] = {
    ...
    {0x11DE, 0x6057, "ZR36067",
     "AV PCI Controller  - Pinnacle DC10plus, Motion-JPEG VideoIO Board"},
    {0x11DE, 0x6067, "zr36067pqc", "zoran"},
    {0x11DE, 0x6120, "ZR36120PQC", "MPEG VideoBVPSXI Capture Card"},
    {0x11DE, 0x6057, "ZR36057PQC",
     "ZORAN PCI Bridge (interface for transferring video across the PCI bus)"},
    {0x11DE, 0x9876, "", ""},
    {0x11EC, 0x0028, "NV05", "MCP67 High Definition Audio"},
    {0x11EC, 0x2064, "", ""},
    {0x11F0, 0x4, "FASTline UTP Quattr",
     "PCI\\VEN_8086&DEV_2772&SUBSYS_0CCB105B&REV_02\\3&2411E6FE&0&10"},
    {0x11F0, 0x4231, "1", "2"},
    {0x11F0, 0x4232, "FASTline UTP Quattr",
     "PCI\\VEN_8086&DEV_2772&SUBSYS_0CCB105B&REV_02\\3&2411E6FE&0&10"},
    ...
    {0x11F6, 0x2011, "TXA9882",
     "ReadyLink  RL100ATX/PCI Fast Ethernet Adapter"},
    ...
    {0x1217, 0x8330, " PCI\\VEN_1217&DEV_8331&SUBSYS_049A1028&REV_05\\4&34",
     "Mass storage controller [0180]"},
    ...
    {0x1223, 0x0001, "KatanaQp",
     "Real-Time Processing Blade in a standard single-slot AdvancedTCA® "
     "formfactor"},
    ...
    {0x1223, 0x008, "Pm3Gv",
     "Up to 8 E1/T1/J1 interfaces for PMC-compatible baseboards"},
    {0x1223, 0x009, "Pm3GE1T1",
     "Third Generation E1 and T1/J1 interfaces for PMC-compatible baseboards"},
    {0x1223, 0x010, "SpiderwareSG", "SIGTRAN Signalling Gateway Blade"},
    {0x1223, 0x011, "SpiderwareSS7",
     "64 SS7 signaling channels on a single blade"},
    {0x1223, 0x012, "SpiderSS7",
     "Portable, STREAMS-Based Implementation of the ITU SS7 Protocol Stack"},
    {0x1223, 0x013, "Spider FRAME RELAY",
     "STREAMS-Based Frame Relay Implementation"},
    {0x1223, 0x014, "Spider STREAMS",
     "Implementation of the UNIX STREAMS Environment"},
    {0x1223, 0x015, "Spider DSF",
     "Transparent STREAMS Interface for High Speed LAN or Shared Memory "
     "Systems"},
    ...
    {0x125D, 0x199B, "ES1938/41/46 solo audio",
     "Maestro-3.COMM PCI Voice+audio"},
    {0x125D, 0x2808, "ES336H", "PCI Fax Modem (later model)"},
    {0x125D, 0x2828, "ES2828S", "TeleDrive"},
    {0x125D, 0x2838, "PCI\\VEN_125D&DEV_2838&SUBSYS_2838125D&REV_01",
     "PCI Data Fax Modem"},
    {0x125D, 0x2839, "2838", "Superlink Modem/V.92 chipset 56K"},
    {0x125D, 0x2898, "2898", "TelDrive ES56T-PI family V.90 PCI modem"},
    {0x125F, 0x2084, "AMCC S5933",
     "AMCC Bridge + 2 x Super I/O (National PC97338)"},
    {0x1260, 0x3860, "PRISM 2.5 ",
     "PRISM 2.5 802.11b 11Mbps Wireless Controller"},
    {0x1260, 0x3872, "PRISM 3", "LAN-Express IEEE 802.11b PCI Adapter"},
    {0x1260, 0x3873, "ISL3886A", "PRISMII.5 IEE802.11g Wireless LAN"},
    {0x1260, 0x3886, "200206BE",
     "Creatix CTX405 WLAN Controller / ZyAir G100 - WLAN"},
    ...
    {0x1382, 0x2009, "PLX TECHNOLOGY \\n PCI9052 \\n 0435 \\n BX9497.1 MALA",
     "SEK'D Prodif 96 Pro - professional audio card"},
    {0x1382, 0x2048, "2048", "Prodif Plus sound card"},
    {0x1382, 0x2088, "Marc 8 Midi", "8-in, 8-out sound card"},
    {0x1268, 0x0204, "Unknown",
     "Tektronix IO Processor / Tektronix PCI Acquisition Interface Rev 204"},
    ...
    {0x1272, 0x0780, "PCI\\VEN_8086&DEV_1C3A&SUBSYS_1670103C&REV_04\\3&115",
     "PCI\\VEN_8086&DEV_1C3A"},
    {0x1272, 0x1272, "PCI\\VEN_8086&DEV_1C3A&SUBSYS_2ABF103C&REV_04",
     "PCI\\VEN_8086&DEV_1C3A&SUBSYS_2ABF103C"},
    {0x1272, 0x9876, "PCI\\VEN_1272&DEV_0780&SUBSYS_00000008&REV_7A\\3&61A",
     "PCI\\VEN_1272&DEV_0780&SUBSYS_00000008&REV_7A\\3&61AAA01&0&58"},
    ...
    {0x13FE, 0x1600, "PCI-1610CU/9-AE",
     "4-port RS-232 UNI PCI COMM card w/S&I&D"},
    {0x13FE, 0x1680, "PCI-1680U-A",
     "2-port CAN UniversalPCI Communication Card with Isolation"},
    {0x13FE, 0x16FF, "PCI-1610CU/9-AE",
     "4-port RS-232 UNI PCI COMM card w/S&I&D"},
    ...
    {0x13FE, 0x1724, "PCI-1723",
     "14-bit, 32-channel Isolated Analog Output Card"},
    ...
    {0x13FE, 0x1762, "PCI-1762",
     "16-ch Relay and 16-ch Isolated Digital Input PCI Card"},
    ...
    {0x129A, 0x0615, "PBT-615",
     "PCI 66MHz and PCI-X 100MHz Bus Analyzer and Exerciser"},
    {0x129A, 0x0715, "Vanguard PCI/PMC/cPCI",
     "PCI 66MHz and PCI-X 133MHz Bus Analyzer and Exerciser"},
    {0x129A, 0xDD10, "DPIO",
     "Digital Parallel Input Output Device 32bit, 33MHz PCI bus"},
    {0x129A, 0xDD11, "DPIO2",
     "Digital Parallel Input Output Device 64bit, 33MHz PCI bus"},
    {0x129A, 0xDD12, "DPIO2-66",
     "Digital Parallel Input Output Device 64bit, 66MHz PCI bus"},
    ...
    {0x12BA, 0x0032, "Hammerhead-Lite-PCI",
     "DSP Prototyping & Development Card"},
    ...
    {0x12F2, 0x3059, "VT8235",
     "AC97 Enhanced Audio Controller - the 8251 controller is different"},
    {0x14C8, 0x0003, "0000066779", "0"},
    {0x12F8, 0x0002, "VideoMaker", "s3 trio"},
    {0x1DE1, 0x0045, "RaidCore5000 Series",
     "Tekram SAS860 Embedded 8xSAS/SATAII RAID"},
    ...
    {0x5333, 0x8901, "pci\\ven_5333dev_8C2E&SUBSYS_00011179&REV_05\\4&74C6",
     "S3 trio64uv+ for windows xp"},
    ...
    {0x5333, 0x8A13, "86C368",
     "Trio3D2x & Trio3D2x+ AGP / Trio3D2x & Trio3D2x+ 8MB"},
    ...
    {0x8086, 0x27B8, "82801GB/GR",
     "Intel(R) 82801GB/GR (ICH7 Family) LPC Interface Controller"},
    {0x8086, 0x0008, "Intel", "Extended Express System Support Ctrlr"},
    {0x8086, 0x0011, "0x108D", "Ethernet Controller"},
    {0x8086, 0x0042, "Intel graphics",
     "Intel Q57/H55 Clarkdale (Onboard on D2912-A1x)"},
    {0x8086, 0x0046, "Intel Graphics Media Accelerator HD",
     "Intel Graphics Media Accelerator HD"},
    {0x8086, 0x0054, "not known", "Audio"},
    {0x8086, 0x0082, "6205", "Centrino Advanced-N 6205 "},
    {0x8086, 0x0083, "Mobile Intel® 5 Series Chipset",
     "Intel® PROSet/Wireless Software and Drivers for Windows 7 32-Bit"},
    {0x8086, 0x0084, "Intel PROSet WiFi 1000",
     "Intel Wireless Link WiFi 1000, download -> "
     "http://downloadmirror.intel.com/20791/eng/Wireless_14.3.0"},
    {0x8086, 0x0085, "0x0280", "Intel Centrino(R) Advanced-N 6205"},
    {0x8086, 0x0087, "1306", "00E1"},
    {0x8086, 0x008A, "???", "Intel Centrino Wireless-N1030"},
    {0x8086, 0x008B, "Intel Wireless-N 1030",
    ...
    {0x8086, 0x0106, "HD Graphics 3000/2000",
    ...
    {0x8086, 0x0189, "Intel Centrino Wireless-N 1030 Bluetooth Adapter",
    ...
    {0x8086, 0x0318, "80219",
     "General Purpose PCI Processor Address Translation Unit"},
    {0x8086, 0x0319, "80219",
     "General Purpose PCI Processor Address Translation Unit"},
    ...
    {0x8086, 0x0482, "82375MB",
     "PCI-EISA Bridge (PCEB)hp dx 7300 microwave tower"},
    ...
    {0x8086, 0x0800, "10B01734",
     "pci/ven_8086&dev_27da&subsys_30b2103c&rev_02\\3&b1bfb68&0&fb"},
    {0x8086, 0x0885, "612BNXHMW", "Intel Centrino Wireless-N + WiMAX 6150"},
    {0x8086, 0x0887, "Intel Centrino Chipset",
    ...
    {0x8086, 0x1010, "82546EB",
     "Dual Port Gigabit Ethernet Controller (Copper)"},
    {0x8086, 0x1011, "82545EM", "Gigabit Ethernet Controller (Fiber)"},
    {0x8086, 0x1012, "82546EB",
     "Dual Port Gigabit Ethernet Controller (Fiber)"},
    ...
    {0x8086, 0x1049, "82566MM NIC",
     "Gigabit Network Connection Interface Controller"},
    ...
    {0x8086, 0x1065, "82801FB/FR/FW/FRW",
     "LAN Controller Intel Corporation 82562ET/EZ/GT/GZ - PRO/100 VE Ethernet "
     "Controller"},
    {0x8086, 0x1068, "82562",
     "1068h 82562ET/EZ/GT/GZ PRO/100 VE Ethernet Controller"},
    ...
    {0x8086, 0x107A, "82546EB",
     "Dual Port Gigabit Ethernet Controller (Fiber)"},
    {0x8086, 0x107B, "82546EB",
     "Dual Port Gigabit Ethernet Controller (Copper)"},
    ...
    {0x8086, 0x1094, "Onboard - Intel PRO 100/VE nic",
     "get PRO2KXP.exe from Intel"},
    ...
    {0x8086, 0x1130, "82815/82815EM/EP",
     "Host-Hub Interface Bridge / DRAM Ctrlr"},
    ...
    {0x8086, 0x1223, "Conexant Cx20468 @ Intel 82801FB ICH6 - AC'97 Audi",
     "Audio Controller"},
    ...
    {0x8086, 0x1228, "EE PRO/100 Smart",
     "Intelligent 10/100 Fast Ethernet Adapter"},
    {0x8086, 0x1229, "1e22",
     "Intel(R) PRO/100 M 00000Desktop Adapter   "
    ...
    {0x8086, 0x1c02, "8086&dev_1c02",
     "Intel(R) Desktop/Workstation/Server Express Chipset SATA AHCI "
     "Controller"},
    {0x8086, 0x1C03, "Intel(R) Mobile Express Chipset SATA AHCI Controll",
     "Intel(R) CPT Chipset Family 6 Port SATA AHCI Controller "},
    {0x8086, 0x1C22, "win7 64-bit (tc40140300b.exe)",
     "Intel(R) 6 Series/C200 Series Chipset Family SMBus Controller"},
    ...
    {0x8086, 0x1C3D, "Intel(R) 6 Series Series Chipset Family",
     "Intel(R) Active Management Technology - SOL"},
    {0x8086, 0x1C49, "FCD01179", "04"},
    {0x8086, 0x1D3A, "X79 series chipset HECI Controller",
     "X79/C600 series chipset Management Engine Interface"},
    ...
    {0x8086, 0x1E22, "Intel(R) 7 SeriesC216 Chipset Family SMBus Host Co",
     "SM-Bus Controller of the Intel Z77 Chipset"},
    {0x8086, 0x1e31, "Intel USB 3.0 eXtensible Host Controller",
     "Intel USB 3.0"},
    {0x8086, 0x1E3A, "PCI\\VEN_8086&DEV_1E3A&SUBSYS_072D1025&REV_04",
     "Intel Management Engine Interface (MEI)"},
    {0x8086, 0x1E3A, "C216", "Intel 7 Series/C216"},
    ...
    {0x8086, 0x2125, "82801AA",
     "AC97 Audio Controller. website to download - "
    ...
    {0x8086, 0x2449, "82559ER",
     "82559ER Integrated 10Base-T/100Base-TX Ethernet Controller"},
    ...
    {0x8086, 0x24C5, "82801DBM SoundMAXController (ICH4-M B0 step)",
     "Realtek AC97"},
    ...
    {0x8086, 0x24D5, "ALC850",
     "Realtek AC'97 &#1047;&#1074;&#1091;&#1082;&#1086;&#1074;&#1086;&#1081; "
     "&#1057;&#1080;&#1089;&#1090;&"},
    ...
    {0x8086, 0x2560, "82845G/GL/GV/GE/PE",
     "DRAM Controller / Host-Hub I/F Bridge"},
    ...
    {0x8086, 0x2570, "82865G/PE/P, 82848P",
    ...
    {0x8086, 0x2582, "82915g/gv/910gl Express Chipset Family",
    ...
    {0x8086, 0x266, "VIA Technologies Vinyl AC'97 Codec Combo Driver (W",
     "VIA AC97 codec incorporated into VT82C686VT8251 SouthbridA/B, VT8231, "
     "VT8233/A/C, VT8235, VT8237/R"},
    ...
    {0x8086, 0x266D, "czc82809kr",
     "http://www.dell.com/support/drivers/us/en/19/DriverDetails/"
     "DriverFileFormats?DriverId=R104087&FileId"},
    {0x8086, 0x266E, "VIA Technologies Vinyl AC'97 Codec Combo Driver (W",
     "VIA AC97, VIA Vinyl (or Tremor) Audio VT1612A, VT1613, VT1616/B, "
     "VT1617/A, VT1618"},
    ...
    {0x8086, 0x2782, "82915G",
     "Graphics device: 82915G/GV/910GL Express Chipset Family"},
    {0x8086, 0x2792, "038000",
     "Mobile Intel(R) 915GM/GMS/, 910GML Express Chipset Family"},
    {0x8086, 0x2794, "945", "Mobile chipset"},
    {0x8086, 0x27A0, "874079", "i945GM Express Chipset"},
    {0x8086, 0x27A1, "Intel 82945PM Memory Controller",
     "Intel Corporation Mobile 945PM Express PCI Express Root Port"},
    {0x8086, 0x27A2, "HPQ0006", "Mobile Intel(R) 945 Express Chipset Family"},
    {0x8086, 0x27A6, "945GM", "Intel 945GM/950"},
    {0x8086, 0x27B8, "945GL",
     "PCI\\VEN_8086&_27B8&SUBSYS_8179DEV1043&REV_01\\3&11583659&0&F8"},
    {0x8086, 0x27BC, "NM10", "NM10 Family LPC Interface Controller"},
    {0x8086, 0x27c0, "82801GB/GR/GH",
     "82801 GB Serial ATA Storage Controllers"},
    ...
    {0x8086, 0x27CC, "82801G",
     "Intel(R) 82801G (ICH7 Family) USB2 Enhanced Host Controller"},
    {0x8086, 0x27D0, "82801G",
     "Intel(R) 82801G (ICH7 Family) PCI Express Root Port"},
    {0x8086, 0x27D2, "82801G",
     "Intel(R) 82801G (ICH7 Family) PCI Express Root Port"},
    {0x8086, 0x27d8, "FF311179",
     "Realtek High Definition Audio Driver FF311179 thequetta.com"},
    ...
    {0x8086, 0x2815, "902D104D",
     "Intel(R) ICH8M LPC Interface Controller - 2815 Driver"},
    {0x8086, 0x2820, "82801HB/HR/HH/HO", "SATA IDE Controller:4 port"},
    {0x8086, 0x2821, "82821HR/HH/HO", "AHCI Controller"},
    {0x8086, 0x2822, "82801HR/HH/HO&82801IR/IH/IO(AIE=0)/ICH10R",
     "Raid Controller"},
    ...
    {0x8086, 0x283A, "81EC1043 (?)",
     "ICH8 Enhanced USB2 Enhanced Host Controller"},
    {0x8086, 0x283E, "PCI\\VEN_8086&DEV_283E&SUBSYS_20A917AA&REV_03\\3&B1B",
     "SM Bus Controller"},
    ...
    {0x8086, 0x2930, "Intel ICH9 Family SMBus Controller",
     "Intel ICH9 Family SMBus Controller"},
    {0x8086, 0x2936, "0x02141028",
     "Intel(R) ICH9 Family USB Univeral Host Controller"},
    {0x8086, 0x293E, "486486 ",
     "82801IB/IR/IH (ICH9 Family) HD Audio Controller"},
    {0x8086, 0x293E, "486486",
     "82801IB/IR/IH (ICH9 Family) HD Audio Controller"},
    {0x8086, 0x294C, "82566DC-2",
    ...
    {0x8086, 0x2997, "Q965/Q963",
     "Intel® Active Management Technology (AMT) - SOL"},
    {0x8086, 0x29a0, "?(82P965)",
     "Intel P965/G965 Processor to I/O Controller"},
    {0x8086, 0x29a1, "?(82Q965, 82G965, 82P965)",
     "Intel P965/G965 PCI Express Root Port"},
    {0x8086, 0x29A2, "Intel 82G965 Graphics and Memory Controller Hub (G",
    ...
    {0x8086, 0x29B4, "Q35-Chipset",
     "Intel(R) Management Engine Interface (HECI)"},
    ...
    {0x8086, 0x2A04, "Q965/Q96",
     "Intel PCI communication controller-Intel Management Engine Interface "
     "update"},
    ...
    {0x8086, 0x2A42, "Mobile Intel 4 Series Chipset Family",
     "Intel Mobile Graphic"},
    {0x8086, 0x2A43, "Mobile Intel 4 Series Chipset Family",
     "Intel Mobile Graphic"},
    ...
    {0x8086, 0x2e13, "Intel Q43/Q45/G43/G45 (Eaglelake) Graphics Control",
     "Intel(R) 4 Series Internal Chipset"},
    {0x8086, 0x2E14, "PCI\\VEN_8086&DEV_2E14",
     "Intel Management Engine Interface (HECI)"},
    {0x8086, 0x2E15, "PCI\\VEN_8086&DEV_29C2&SUBSYS_29C28086&REV_10\\3&115",
     "Intel AMT LMS_SOL for AMT 5.xx"},
    {0x8086, 0x2E16, "4x", "IDE Controller"},
    {0x8086, 0x2E17, "CC_0700", "Intel AMT LMS_SOL for AMT 5.xx"},
    {0x8086, 0x2E24, "PCI\\VEN_8086&DEV_27D8&SUBSYS_30AA103C&REV_01\\3&B1B",
     "Intel Management Engine Interface"},
    {0x8086, 0x2E26, "4x", "IDE Controller"},
    {0x8086, 0x2e29, "2e29",
     "Intel(R) 4 Series Chipset PCI Express Root Port - 2E29"},
    {0x8086, 0x2E32, "PCI\\VEN_8086&DEV_2E32&SUBSYS_31031565&REV_03",
    ...
    {0x8086, 0x2f00, "815B104D",
     "multimedia audio device (codec AC97) SoundMAX or VIA"},
    ...
    {0x8086, 0x3423, "The Intel® Server RAID Controller U2-1 (SRCU21) an",
     "SRCU21/SRCU31 Microsoft Windows* 2000 Memory Management Files"},
    {0x8086, 0x3464, "22", "NTPNP_PCI0002"},
    {0x8086, 0x348D, "82541EI", "Gigabit Ethernet Controller"},
    {0x8086, 0x34c5, "82801DBM SoundMAXController (ICH4-M B0 step)",
     "Realtek AC97 (NOT an intel)"},
    ...
    {0x8086, 0x3582, "852GM/GMV or 82852/82855 GM/GME",
    ...
    {0x8086, 0x360B, "PCI\\VEN_8086&DEV_1C3A&SUBSYS_04B01028&REV_04\\3&115",
     "intel simple communication controller"},
    ...
    {0x8086, 0x3A3E, "Microsoft UAA Bus Driver for High Definition Audio",
     "Microsoft UAA Bus Driver for High Definition Audio"},
    {0x8086, 0x3a60, "ICH10", "SM-Bus Controller"},
    {0x8086, 0x3B00, "Intel(R) 5 Series/3400 Series Chipset Family",
     "LPC Interface Controller"},
    {0x8086, 0x3B01, "Intel(R) 5 Series/3400 Series Chipset Family",
     "LPC Interface Controller"},
    {0x8086, 0x3B02, "Intel(R) 5 Series/3400 Series Chipset Family",
     "LPC Interface Controller"},
    {0x8086, 0x3B03, "Intel(R) 5 Series/3400 Series Chipset Family",
     "LPC Interface Controller"},
    {0x8086, 0x3B06, "Intel(R) 5 Series/3400 Series Chipset Family",
     "LPC Interface Controller"},
    {0x8086, 0x3B07, "Intel(R) 5 Series/3400 Series Chipset Family",
     "LPC Interface Controller"},
    {0x8086, 0x3B08, "Intel(R) 5 Series/3400 Series Chipset Family",
     "LPC Interface Controller"},
    {0x8086, 0x3B09, "Intel(R) 5 Series/3400 Series Chipset Family",
     "LPC Interface Controller"},
    {0x8086, 0x3B0A, "Intel(R) 5 Series/3400 Series Chipset Family",
     "LPC Interface Controller"},
    {0x8086, 0x3B0B, "Intel(R) 5 Series/3400 Series Chipset Family",
     "LPC Interface Controller"},
    {0x8086, 0x3B0D, "Intel(R) 5 Series/3400 Series Chipset Family",
     "LPC Interface Controller"},
    {0x8086, 0x3B0F, "Intel(R) 5 Series/3400 Series Chipset Family",
     "LPC Interface Controller"},
    {0x8086, 0x3B12, "Intel(R) 5 Series/3400 Series Chipset Family",
     "LPC Interface Controller"},
    {0x8086, 0x3B14, "Intel(R) 5 Series/3400 Series Chipset Family",
     "LPC Interface Controller"},
    {0x8086, 0x3B16, "Intel(R) 5 Series/3400 Series Chipset Family",
     "LPC Interface Controller"},
    ...
    {0x8086, 0x3B30, "Intel(R) 5 Series/&#1057;&#1077;&#1088;&#1080;&#11",
     "SMBus "
     "&#1050;&#1086;&#1085;&#1090;&#1088;&#1086;&#1083;&#1083;&#1077;&#1088;"},
    {0x8086, 0x3B32, "Intel(R) Turbo Boost Technology Driver",
     "LPC Interface Controller"},
    {0x8086, 0x3b63, "ff1e1179", "06"},
    {0x8086, 0x3B64, "Intel  3B09", "Management Engine Driver"},
    {0x8086, 0x3b65, "ff1e1179", "06"},
    {0x8086, 0x3B67, "Vendor ID 0x8086 ",
     "Intel(R) Active Management Technology - Serial Over LAN (SOL) "},
    {0x8086, 0x4000, "Creatix", "V.90 HaM Modem"},
    {0x8086, 0x402f, "-",
     "Intel (R) 5400 Chipset QuickData Technology device - 402F"},
    ...
    {0x8086, 0x4223, "2915ABG",
     "Intel (R) PRO/Wireless 2200BG Network Connection, (R) PRO/Wireless "
     "2915ABG Network Connection"},
    {0x8086, 0x42231, "2915ABG",
     "Intel (R) PRO/Wireless 2200BG Network Connection, (R) PRO/Wireless "
     "2915ABG Network Connection"},
    {0x8086, 0x4224, "Intel Pro Wireless 2915ABG", "802.11a/b/g WLan adapter"},
    {0x8086, 0x4227, "3945ABG", "Intel(R) PRO/Wireless 3945ABG"},
    {0x8086, 0x4229, "Intel 4965AGN",
     "Intel® Wireless WiFi Link 4965AGN(supporting 802.11a/b/g/Draft-N)"},
    ...
    {0x8086, 0x4232, "Intel® WiFi Link 5100",
     "Carte Intel® WiFi Link 5100 AGN"},
    ...
    {0x8086, 0x7100, "82439TX",
     "System Controller (MTXC), part of 430TX chipset"},
    ...
    {0x8086, 0x7113, "82371AB/EB/MB",
     "PIIX4/4E/4M Power Management Controller"},
    {0x8086, 0x7120, "Intel(R) 82801IMB",
     "Host-Hub Interface Bridge / DRAM Ctrlr"},
    ...
    {0x8086, 0x8083, "Intel PM45",
     "Intel Wireless WiFi Link 5100 ABGN 10/100/1000 Base T"},
    {0x8086, 0x8086, "https://downloadcenter.intel.com/detail_desc.aspx?",
     "PCI-&#1050;&#1086;&#1085;&#1090;&#1088;&#1086;&#1083;&#1083;&#1077;&#"
     "1088; Simple Communications"},
    {0x8086, 0x80861, "(0x2994)", "Intel(R) Management Engine Interface"},
    {0x8086, 0x8108, "SCH US15WP",
     "Intel(R) Graphics Media Accelerator 500  "
     "http://downloadcenter.intel.com/Detail_Desc.aspx?lang=eng&D"},
    ...
    {0x8086, 0x9877, "1", "1"},
    {0x8086, 0x9888, "HDAUDIO\\FUNC_01&VEN_8086&DEV_27d8&SUBSYS_80860101&",
     "HDAUDIO\\FUNC_01&VEN_8086&DEV_27d8&REV_1000"},
    {0x8086, 0x9998, "42468068", " 02"},
    {0x8086, 0x9999, "pci30b2103c", "Interface chip"},
    {0x8086, 0x9C22, "PCI\\VEN_8086&DEV_9C22&SUBSYS_05EC1028&REV_04 ",
     "Intel Chipset"},
    {0x8086, 0x9C3A, "PCI\\VEN_8086&DEV_9C3A&SUBSYS_90B6104D&REV_04",
     "Intel Management Engine Interface driver"},
    {0x8086, 0xA001, "3150", "Intel Media Accelerator 3150"},
    {0x8086, 0xA002, "GMA 3150",
     "Intel® Grafik-Media-Accelerator 3150 (Intel® GMA 3150)"},
    ...
    {0x9004, 0x3B78, "AHA-4944W/4944UW",
     "QuadChannel Fast-Wide/Ultra-Wide Diff. SCSI Ctrlr"},
    ...
    {0x9004, 0x7278, "AHA-3940/3940W",
     "Multichannel Fast/Fast-Wide SCSI Ctrlr"},
    {0x9004, 0x7378, "AHA-3985", "4-chan RAID SCSI Ctrlr"},
    {0x9004, 0x7478, "AHA-2944", "SCSI Ctrlr"},
    {0x9004, 0x7578, "AHA-3944/3944W",
     "Multichannel Fast/Fast-Wide Diff. SCSI Ctrlr"},
    {0x9004, 0x7678, "AHA-4944W/4944UW",
     "QuadChannel Fast-Wide/Ultra-Wide Diff. SCSI Ctrlr"},
    ...
    {0x9004, 0x8578, "AHA-3944U/3944UWD",
     "Fast-Wide/Ultra-Wide Diff. SCSI Ctrlr"},
    ...
    {0x9004, 0xEC78, "AHA-4944W/4944UW",
     "QuadChannel Fast-Wide/Ultra-Wide Diff. SCSI Ctrlr"},
    ...
    {0x1524, 0x1025, "1025123",
     "PCI\\VEN_127a&DEV_1025&SUBSYS_1025123A&REV_01\\4&1351887D&0&58F0"},
    ...
    {0x153B, 0x1115, "ICE1712 Envy24",
     "IC Ensemble Inc ICE1712 Envy24 Multichannel Audio Controller"},
    {0x153B, 0x1143, "SAA7134HL",
     "Philips Semiconductors SAA7134HL Multimedia Capture Device"},
    {0x153B, 0x6003, "CS4614/22/24",
     "CrystalClear SoundFusion PCI Audio Accel"},
    {0x153F, 0xdead, "xx12345", "Not a chip ..."},
    {0x1540, 0x9524, "saa7130",
     "PAL/SECAM TV card w/ FM1216ME MK3 tuner (+FM radio)"},
    ...
    {0x1543, 0x3155, "Infineon TPM Professional ",
    ...
    {0x15B3, 0x634A, "MT2518",
     "Mellanox ConnectX VPI (MT2548) - PCIe 2.0 2.5GT/s, IB DDR /10GigE "
     "Network Adaptor"},
    {0x15B3, 0x6732, "MT26418",
     "ConnectX VPI (MT26418) - PCIe 2.0 5GT/s, IB DDR / 10GigE"},
    ...
    {0x15DD, 0x769, "7690",
     "9200 HD ÐÑƒÐ´Ð¸Ð¾ ÐšÐžÐ”Ð•Ðš"},
    {0x15DD, 0x7690, "10F70000",
     "You'll Love me 4 this/ visit http://wendhelofopportunity.info Support "
     "Me!"},
    {0x15DD, 0x8384, "HDAUDIO\\FUNC_01&VEN_8384&DEV_7616&SUBSYS_1028020A&",
     "Intel Audio Studio"},
    {0x15DD, 0x9876, "1", "1"},
    ...
    {0x15EF, 0x0028, "8280BDM SoundMAX Controller (ICH7-M B0 Setup)",
     "SigmaTelHigh Definition Audio CODEC"},
    {0x15EF, 0x24c5, "8280BDM SoundMAX Controller (ICH4-M B0 Setup)",
     "VIA-Vynil v700b"},
    ...
    {0x1616, 0x0409, "DaqBoard/2000",
     "16-Bit, 200-kHz PCI Data Acquisition DaqBoards with DBK Signal "
    ...
    {0x1619, 0x1612, "FarSync TE1e (PCI Express)",
     "One Port Intelligent Sync Comms Card"},
    ...
    {0x1619, 0x4620, "FarSync T2Ue (PCI Express)",
     "Two Port Intelligent Sync Comms Card"},
    {0x1619, 0x4640, "FarSync T4Ue (PCI Express)",
     "Four Port Intelligent Sync Comms Card"},
    {0x1619, 0x5621, "FarSync T2Ee (PCI Express)",
     "Two Port Intelligent Sync Comms Card"},
    {0x1619, 0x5641, "FarSync T4Ee (PCI Express)",
     "Four Port Intelligent Sync Comms Card"},
    ...
    {0x163B, 0x2416, "Techwell - TW2804  Model - JSA-2416Drivers on this",
     "DVR Video Capture Card 16CH"},
    ...
    {0x18CA, 0x0020, "Volari Z9s",
     "Volari Z series (Select GPU Graphic Drivers"},
    ...
    {0x12B9, 0x1008, "USR5610B",
     "USR5610B (0005610-02) 56K Performance Pro Modem (PCI Internal)"},
    {0x12B9, 0x12b9, "00000005", "psi simple communication controller"},
    {0x12B9, 0x3F0, "3CP2977",
     "US Robotics 56K Fax PCI aka Model 0726, V.90 56K Internal Faxmodem"},
    {0x1814, 0x0001, "...B742000", "...I don't know"},
    {0x1814, 0x0101, "2460  802.11b",
     "RT2460  802.11b Baseband/MAC integrated chip"},
    {0x1814, 0x0201, "PCI\\VEN_1814&DEV_3090&SUBSYS_1451033",
     "Ralink Chipset 802.11b/g WLAN Card"},
    {0x1814, 0x0301, "RT2561", "Ralink RT2561 Wireless-G PCI"},
    {0x1814, 0x0302, "RT2525 2.4GHz transceiver + RT2560 MAC/BBP",
     "wireless p/n same Chipset in D-Link DWL-G510"},
    ...
    {0x1814, 0x0781, "RT2790T/RT2860/RT2890/RT2700E",
     "Wireless 802.11 bgn PCI-e"},
    {0x1814, 0x1418, "0x14FI", "802.11b/g Wireless LAN"},
    {0x1814, 0x14F1, "0x1814",
     "PCI\\VEN_168C&DEV_001A&SUBSYS_04181468&REV_01\\4&FCF0450&0&10A4"},
    {0x1814, 0x201, "25601814&REV_01", "Ralink RT2500 Wireless Lan Card"},
    {0x1814, 0x3060, "RT3060",
     "Ralink corp. RT3060 Wireless 802.11n PCI adapter"},
    {0x1814, 0x3090, "Ralink RT3090",
     "Ralink RT3090 Wireless Lan Card with Bluetooth"},
    {0x1814, 0x3290, "RT3290", "802.11n + Bluetooth 4.0"},
    {0x1814, 0x3298, "-", "Ralink Bluetooth"},
    {0x1814, 0x3592, "RT3592", "Wireless LAN a/b/g/n plus Bluetooth 3.0 combo"},
    {0x1814, 0x5360, "RT5360 ",
    ...
    {0x18F7, 0x0001, "ESCC-PCI-335",
     "Fastcom:ESCC-PCI-335 Syncronous RS422/485 serial communication adapter"},
    {0x18F7, 0x0002, "422/4-PCI-335",
     "Fastcom:422/4-PCI-335 Asyncronous RS422/485 serial adapter"},
    {0x18F7, 0x0004, "422/2-PCI-335",
     "Fastcom:422/2-PCI-335 Asyncronous RS422/485 serial adapter"},
    {0x18F7, 0x000a, "232/4-PCI-335",
     "Fastcom:232/4-PCI-335 Asyncronous RS232 serial adapter"},
    {0x1737, 0x0071, "RT2870", "Dual Band Wireless N USB Network Adapter"},
    {0x1737, 0x1032, "EG1032 v3",
     "Linksys Instant Gigabit Desktop Network Interface"},
    {0x19AC, 0x0001, "ACA2400", "Crypto Accelerator"},
    {0x110A, 0x2101, "PEB 20321",
     "Multichannel Network Interface Controller for HDLC"},
    {0x110A, 0x2102, "PEB 20534",
     "DMA supported serial communication controller with 4 channels"},
    {0x110A, 0x2104, "PSB4610",
     "PCI Interface for Telephony/Data Applications PITA-2"},
    ...
    {0x1180, 0x0832, "ACPI\\ENE0100\\4&15458EF3&0",
     "ACPI\\ENE0100\\4&15458EF3&0"},
    ...
    {0x1180, 0xE230, "GM45 &#1053;&#1086;&#1084;&#1077;&#1088; &#1063;&#",
     "Ricoh PCIe Memory Stick "
     "&#1061;&#1086;&#1089;&#1090;-&#1050;&#1086;&#1085;&#1090;&#1088;&#1086;&#"
     "108"},
    {0x1180, 0xe476, "Ricoh R5C843",
     "Multipurpose chip, this e476 seems to be the CardBus controller part"},
    ...
    {0x14F1, 0x1035, "R6795-11",
     "RH56D/SP-PCI, R6795-11, E416921/1, 0336 Mexico"},
    ...
    {0x14F1, 0x2C06, "136",
     "Conexant HD Audio SoftV92 Data Fax Modem with SmartCP"},
    {0x14F1, 0x2F00, "00101767", "HSF 56k HSFi Modem"},
    {0x14F1, 0x2f01, "0x0780",
     "missing driver for pci simple communications controller"},
    ...
    {0x14F1, 0x2F81, " ", " "},
    {0x14F1, 0x2F82, "cx9510-11z",
     "Conexant PCI-E Soft Data/Fax Modem with SmartCP"},
    {0x14F1, 0x5045, "4.0.3.1",
     "http://h10025.www1.hp.com/ewfrf/wc/"
     "softwareDownloadIndex?softwareitem=ob-43284-1&lc=en&dlc=en&cc=us&"},
    {0x14F1, 0x50451, "14f12f30",
     "Conextant High Definition Audio-Venice 5051"},
    {0x14F1, 0x50452, "14e4", "Conextant High Definition SmartAudio 221"},
    {0x14F1, 0x50452, "PCI\\VEN_14F1&DEV_5047",
     "Conextant High Definition Audio-Venice 5051"},
    {0x14F1, 0x5047, "Not sure",
     "HDAUDIO Soft Data Fax Modm- Conexant Sound Card Audio Driver"},
    {0x14F1, 0x5051, "4.0.1.6", "Conexant HD-Audio SmartAudio 221"},
    {0x14F1, 0x5066, "Cx20561",
     "HDAUDIO\\Func_01&VEN_14F1&DEV_5069&SUBSYS_17AA214C&REV_1003"},
    ...
    {0x14F1, 0x5B7A, "Belived to be a CX23416",
    ...
    {0x14F1, 0x8880, "CX23888",
     "PCI Express Video and Broadcast Audio Decoder"},
    {0x14F1, 0x9876, "PCI\\VEN_14F1&DEV_2F20&SUBSYS_200F14F1&REV_00\\4&1AF",
     "f"},
    {0x186C, 0x1014, "AR5BXB6", "Atheros 802.11abg"},
    {0x1971, 0x0001, "PCI\\\\VEN_1971&DEV_0000&SUBSYS_00021028&REV_00\\\\4&2",
     "AGEIA PhysX 100 Series PCI Express Card"},
    {0x1971, 0x1011, "PCI\\\\VEN_1971&DEV_1011&CC_FF00",
    ...
    {0x1969, 0x1048, "Atheros L1",
     "Gigabit Ethernet 10/100/1000 Base-T Controller"},
    {0x1969, 0x1060, "AR8162", "PCI-E Fast Ethernet Controller"},
    {0x1969, 0x1062, "AR8132",
     "Atheros AR8132 PCI-E "
     "&#1050;&#1086;&#1085;&#1090;&#1088;&#1086;&#1083;&#1083;&#1077;&#1088; "
     "Fast Eth"},
    {0x1969, 0x1062c, "Atheros L1 ",
     "Gigabit Ethernet 10/100/1000 Base-T Controller"},
    {0x1969, 0x1063, "AR8131",
    ...
    {0x1969, 0x168c, "Atheros L1 ",
     "Gigabit Ethernet 10/100/1000 Base-T Controller "},
    {0x1969, 0x1969, "Atheros L1 ",
     "Gigabit Ethernet 10/100/1000 Base-T ÐšÐ¾Ð½Ñ‚Ñ€Ð¾Ð»Ð»ÐµÑ€ "},
    ...
    {0x8080, 0x1040, "VIA 82C259 rev 0",
     "PCI\\VEN_8086&DEV_1040&SUBSYS_1008086&REV_00"},
    ...
    {0x0c45, 0x610C, "USB\\VID_0C45&PID_610B\\7&3211544E$0$2",
     "usb web camera "},
    ...
    {0x0c45, 0x624f, "Sonix SN9C201",
     "Integrated Webcam in Compal HEL81 series barebones."},
    {0x0c45, 0x6270, "USB\\VID_0C45&PID_6270", "USB Microscopr"},
    {0x0c45, 0x627F, "USB\\VID_17A1&PID_0118&REV_0100",
     "USB\\VID_17A1&PID_0118&REV_0100"},
    {0x0c45, 0x62B3, "USB\\Vid_0c45&Pid_62b3&Rev_0100&MI_00",
     "USB 2.0 PC Camera"},
    {0x0c45, 0x62BF, "USB\\Vid_0c45&Pid_62bf",
     "USB\\Vid_0c45&Pid_62bf&Rev_0100"},
    {0x0c45, 0x62c0, "SNP2UVC", "Sonix Wecam"},
    {0x0c45, 0x6353, "USB\\VID_0000&PID_0000\\5&21F6DCD1&0&5",
     "USB Microscope"},
    {0x0c45, 0x641D, "USB\\VID_0C45&PID_643d",
     "1.3 MPixel Integrated Webcam used in Dell N5010 series"},
    {0x0c45, 0x6421, "USB\\VID_0C45&PID_6421&REV_0224&MI_00",
     "USB 2.0 Webcam slim 32"},
    {0x0c45, 0x642F, "USB\\VID_0C45&PID_642F&REV_1224", "Webcam"},
    {0x0c45, 0x644b, "not known", "not known"},
    {0x0c45, 0x6489, "0x6489",
     "Integrated Webcam Universal Serial Bus controllers"},
    {0x0c45, 0x6840, "USB\\VID_0C45&PID_6480&MI_00 ",
     "sonix 1.3 mp laptop integrated webcam"},
    {0x0c45, 0x9876, "USB\\VID_090C&PID_B371&MI_00\\6&462987E&0&0000",
     "webcam"},
    {0x0A5C, 0x0201, "Blutonium BCM2035 Bluetooth 2.4 GHz Single Chip Tr",
     "Broadcom USB iLine10(tm) Network Adapter"},
    ...
    {0x0A5C, 0x2033, "  1ujy100539f",
     "Broadcom Blutonium Device Firmware Downloader"},
    {0x0A5C, 0x2035, "5&263C7E89&0&1", "BCM92035NMD Bluetooth"},
    {0x0A5C, 0x2038, " ",
     "Broadcom Blutonium Device Firmware Downloader (BCM2038)"},
    ...
    {0x0A5C, 0x2121, " ",
     "Broadcom 2045 Bluetooth 2.0 USB Device with trace filter"},
    ...
    {0x0A5C, 0x8613, "USB\\VID_04B4&PID_8613&REV_:001",
     "TD 3104 USB vedio grabber "},
    ...
    {0x197B, 0x2361, "JMB363",
     "PCI Express to SATA II and PATA Host Controller"},
    ...
    {0x197B, 0x2393, " Chip Number:   JMB38X",
     "Chip Description:   JMB38X SD/MMC Host Controller"},
    ...
    {0x058f, 0x6387, "3F83C15F", "Transcend JetFlash Flash Drive"},
    {0x058f, 0x9254, "AU9254A21-HAS",
    ...
    {0x198a, 0x4033, " PCI\\VEN_198A&DEV_4033&SUBSYS_00000000&REV_00",
     "BenONE-Xilinx-Kit-ROHS"},
    ...
    {0x04B3, 0x24D5, "PCI\\VEN_8086&DEV_293E&SUBSYS_20F217AA&REV_03\\3&B1B",
     "Audio Controller"},
    {0x04B3, 0x401, "8086",
     "PCI\\VEN_8086&DEV_293E&SUBSYS_20F217AA&REV_03\\3&B1BFB68&0&D8  "},
    {0x04B3, 0x401, "24C6", "PCI\\VEN_8086&DEV_24C5&REV_01\\3"},
    {0x04B3, 0x4010, "CC_040100",
     "PCI\\VEN_8086&DEV_1C22&SUBSYS_FCD01179&REV_04"},
    {0x04B3, 0x9876, "CC_040100",
     "PCI\\VEN_8086&DEV_293E&SUBSYS_20F217AA&REV_03\\3&B1BFB68&0&D8"},
    ...
    {0x7d1, 0x3C07, "D-Link Wireless G DWA-110 USB Adapter",
    ...
    {0x19a2, 0x0712, "",
     "Emulex OneConnect 10Gb iSCSI Initiator (be3) (rev 01)"},
    {0x19a2, 0x0714, "Emulex OneConnect 10Gb FCoE Initiator (be3) (rev 0",
     "Emulex OneConnect 10Gb FCoE Initiator (be3) (rev 02)"},
    ...
    {0x138A, 0x0018, "Biometric Devices",
     "Validity Sensors, Inc. (WBF) (PID=0018)"},
    ...
    {0x046D, 0xC018, "?",
     "Baesline 3 Button Corded Optical Mouse, 2 button + scroll wheel"},
    {0x046D, 0xC045, "M/N: M-BZ96C. P/N: 810-000207. PID: HS91013.",
     "Epoxy Hidden"},
    ...
    {0x10EC, 0x8136, "Realtek AC97Audio drivers",
     "Realtek 171 High Definition Audio"},
    {0x10EC, 0x0062, "LSISAS1078", "PCI-Express Fusion-MPT SAS"},
    {0x10EC, 0x0185, "802.11b",
     "Realtek 8180 Extensible 802.11b Wireless Device"},
    {0x10EC, 0x0200, "RTL8102E", "Realtek 10/100/1000 PCI-E NIC Family"},
    {0x10EC, 0x0260, "Realtek ALC260 High Definition Audio",
     "HDAUDIO\\FUNC_01&VEN_10EC&DEV_0262&SUBSYS_144DC034&REV_1002"},
    {0x10EC, 0x0262, "Realtek ALC 262", "Realtek ALC 262 Audio"},
    ...
    {0x10EC, 0x0660, "HDAUDIO\\FUNC_01&VEN_10EC&DEV_0660&SUBSYS_10191386&",
     "HD Audio"},
    ...
    {0x10EC, 0x0882, "Realtek ALC882/D/M",
     "Intel 82801GB ICH7 - High Definition Audio Controller"},
    {0x10EC, 0x0883, "ALC883", "Realtek High definition Audio"},
    {0x10EC, 0x0887, "FUNC_01&VEN_10EC&DEV_0887&SUBSYS_1458A002&REV_1002",
     "xHDAUDIO\\FUNC_01&VEN_10EC&DEV_0887&SUBSYS_104383BC&REV_1002\\4&159EE542&"
     "0&0001"},
    {0x10EC, 0x0888, "ALC260", "Realtek High Definition Audio"},
    {0x10EC, 0x0888, "ALC660", "Realtek High Definition Audio"},
    {0x10EC, 0x0889, "1Device Ses G&#305;gabyte&#1058;&#1077;&#1093;",
    ...
    {0x10EC, 0x8136, "RTL8102ENetwork Controller  PCI\\VEN_10EC&DEV_8136&S",
     "Realtek 10/100/1000 PCI-E NIC Family"},
    {0x10EC, 0x8137, "RTL8102E", "Realtek 10/100/1000 PCI-E NIC Family"},
    {0x10EC, 0x8139, "RTL8139http://pcidatabase.com/update_device.php? _",
     "Realtek RTL8139 &#1057;&#1077;&#1084;&#1100;&#1080; PCI Fast Ethernet "
     "NIC"},
    {0x10EC, 0x8167, "RTL8167", "Realtek RTL8169/8110"},
    {0x10EC, 0x8168, "RTL8168E/RTL8111F/RTL",
     "PCIe GBE Ethernet Family Controller"},
    {0x10EC, 0x8169, "8169S",
     "Realtek RTL8169\\8110 &#1057;&#1077;&#1084;&#1100;&#1080; Gigabit "
     "Ethernet"},
    ...
    {0x10EC, 0x8171, "8172",
     ...
     "&#1041;&#1077;&#1089;&#1087;&#1088;&#1086;&#1074;&#1086;&#1076;&#1085;&#"
     "1086;&#108"},
    {0x10EC, 0x8172, "RTL8191SE-VA2",
     "Single-Chip IEEE 802.11b/g/n 1T2R WLAN Controller with PCI Express "
     "Interface"},
    {0x10EC, 0x8174, "RTL8188RU", "Realtek RTL8188RU"},
    {0x10EC, 0x8176, "RTL8188CE",
    ...
    {0x10EC, 0x8191, "RTL8192CE",
     "Single-Chip IEEE 802.11b/g/n 2T2R WLAN Controller with PCI Express "
     "Interface"},
    {0x10EC, 0x8199, "RTL8187SE",
     "http://www.realtek.com/downloads/"
     "downloadsView.aspx?Langid=1&PNid=21&PFid=40&Level=5&Conn=4&DownType"},
    ...
    {0x10EC, 0x9876, "Realtek AC97Audio drivers",
     "Realtek 171 High Definition Audio"},
    {0x10EC, 0xA167, "Realtek RTL8110SC-GR", "Realtek RTL8110SC-GR"},
    {0x10EC, 0xB723, "unkown",
     "Realtek RTL8723BE Wireless LAN 802.11n PCI-NIC #4"},
    ...
    {0x093a, 0x2468, "Genius iLook 110",
     "http://genius.ru/products.aspx?pnum=24948&archive=1"},
    {0x093a, 0x2608, "PAC7311 - Toshiba PX1342E-1 CAM",
     "USB\\VID_093A&PID_2608&REV_0100&MI_00"},
    {0x093a, 0x2620, "CNR-WCAM53G",
     "WEBCAM "
     "http://www.canyon-tech.com/archive/voip/webcams/CNR-WCAM53#pr-switcher"},
    ...
    {0x1B73, 0x1000, "1",
     "PCI\\VEN_1000&DEV_0020&SUBSYS_10301000&REV_01PCI\\VEN"},
    {0x1B73, 0x1100, "n/a", "USB 3.0 eXtensibile Host controller"},
    {0x17FE, 0x2220, "n/a", "Generic IEEE 802.11b/g Wireless LAN Card"},
    {0x0DF6, 0x9071, "   \\t9071\\t WL-113 - Wireless Network USB dongle 5",
     "\\t9071\\t   WL-113 - Wireless Network USB dongle 54g  "},
    {0x1682, 0x9875, "", ""},
    {0x1B6F, 0x7023, "DEV_7023&REV_010",
    ...
    {0x0cf3, 0x1002, "Wireless USB 2.0 adapter TL-WN821N",
     "Wireless USB 2.0 adapter TL-WN821N"},
    {0x0cf3, 0x3000, "&#1085;&#1077;&#1080;&#1079;&#1074;&#1077;&#1089;&",
     "&#1085;&#1077;&#1080;&#1079;&#1074;&#1077;&#1089;&#1090;&#1085;&#1086;&#"
     "1077; &#1091;&#1089;&#1090;&"},
    {0x0cf3, 0x3005, "AR3011", "Atheros Bluetooth Module"},
    {0x0cf3, 0x9271, "0x0108",
     "TP-LINK 150 Mbps Wireless Lite N Adapter TL-WN721N"},
    {0x1491, 0x0020, "USB Fingerprint Scanner Model FS80",
     "USB Fingerprint Scanner Model FS80"},
    {0x1491, 0x0021, "USB Fingerprint Scanner Model FS80",
     "USB Fingerprint Scanner Model FS80"},
    ...
    {0x0A92, 0x1010, "1010&REV_0101&MI_00",
     " RoMI/o by Egosys - Midi USB Cable"},
    {0x1B21, 0x1041, "SUBSYS_21047174",
     "USB 3.0 Host Controller Driver for Windows 7"},
    ...
    {0x168C, 0x0027, "E017105B",
     "Atheros AR5B95 Wireless LAN 802.11 a/b/g/n Controller"},
    {0x168C, 0x0030, "PCI\\VEN_168C&DEV_0030&SUBSYS_3112168C&REV_01",
     "TP-LINK 450Mbps Wireless N Adapter"},
    {0x168C, 0x0007, "AR5007EG", "Wireless Network Adapter"},
    {0x168C, 0x0011, "11a/b/g Wireless LAN Mini PCI Adapter",
     "11a/b/g Wireless LAN Mini PCI Adapter"},
    {0x168C, 0x0012, "AR5211",
     " PCI\\VEN_1217&DEV_7130&SUBSYS_FF501179&REV_01 DELL Latitude C510 as "
     "mini-PCI board behind the larg"},
    {0x168C, 0x0013, "Netgear WPN311",
     "Netgear RangeMax WPN311 PCI Wireless NIC"},
    {0x168C, 0x0019, "AR5bmb5", "802.11a Wireless Adapter"},
    {0x168C, 0x001A, "Atheros AR5005GS",
     "http://support1.toshiba-tro.de/tools/updates/atheros-wlan/"
     "atheros-wlan-xp-7702331.zip"},
    {0x168C, 0x001B, "AR5006X", "802.11abg NIC"},
    {0x168C, 0x001c, "HDAUDIO\\FUNC_01&VEN_8384&DEV_7698&SUBSYS_161F2073&",
     "Wireless Network Adapter"},
    {0x168C, 0x001D, "TP-Link TL-WN350GD",
     "PCI\\VEN_168C&DEV_002E&SUBSYS_E034105B&REV_01\\4&124A40C8&0&00E1"},
    {0x168C, 0x002, "c660", "the drivers for this device are not installed"},
    {0x168C, 0x0023, "AR5416",
     "802.11a/b/g/"
     "n&#1041;&#1077;&#1089;&#1087;&#1088;&#1086;&#1074;&#1086;&#1076;&#1085;&#"
     "1086;&#1081; PC"},
    ...
    {0x168C, 0x002C, "AR5008",
     "Wireless 802.11 a/b/g/n Dualband Network Adapter (PCI-Express)"},
    {0x168C, 0x002D, "AR9287 rev01", "802.11b/g/n"},
    {0x168C, 0x002E, "AR9287",
     "Atheros ar9287 PCI Capabilities:  Offset ID Description "},
    ...
    {0x168C, 0x6666, "AR5007UG",
     "Atheros AR5B95 Wireless LAN 802.11 a/b/g/n Controller"},
    {0x168C, 0x9876, "AR5B95",
     "Atheros AR5B95 Wireless LAN 802.11 a/b/g/n Controller"},
    ...
    {0x4144, 0x005F, "ADM-XRC-5T2-ADV6",
     "As per XRC-5T2 but with 6 JPEG2000 devices"},
    {0x4144, 0x0300, "ADM-XRC-6T1", "Xilinx Virtex 6 FPGA XMC"},
    {0x4144, 0x0301, "ADM-XRC-6TGE", "Xilinx Virtex 6 FPGA XMC"},
    {0x4144, 0x0303, "ADPe-XRC-6T-L",
     "Full lenght PCI Express Xilinx Virtex-6 FPGA platform"},
    {0x4144, 0x0305, "ADPe-XRC-6T",
     "Full length PC Card Xilinx Virtex-6 FPGA platform"},
    ...
    {0x167F, 0x5344, "SD \\ VID_03 Ð¸ OID_5344 Ð¸ PID_SU01G Ð¸ REV_8.0",
     "FOB-SD Card"},
    ...
    {0x16EC, 0x0303, "Rev_0200",
     "U.S. Robotics 56K FAX USB V1.1.0 /  V.92 USB modem"},
    ...
    {0x16EC, 0x5685, "E129336-1",
     "U.S. Robotics 56K Voice Host Int (A-Modem/ PCI)"},
    ...
    {0x0E11, 0x005A, "PowerPC 405GP processor at 200MHz [3305103C]",
     "HP Remote Insight Lights-Out II Board"},
    {0x0E11, 0x00B1, "3305103C", "HP Remote Insight Lights-Out II PCI Device"},
    {0x0E11, 0x00C0, "Adaptec AIC-7899G",
     "64Bit,66MHz,Dual Channel WideUltra3 SCSI"},
    ...
    {0x0E11, 0xA0F7, "PCI bus 6, device 4, function 4",
    ...
    {0x0E11, 0xB030, "Netelligent WS 1500",
     "10/100TX Embedded UTP/Coax Controller"},
    ...
    {0x0E11, 0xF095, "FCA2101",
     "HP StorageWorks 2 Gb, 64-Bit/66-MHz PCI-to-Fibre Channel Host Bus "
     "Adapter for Windows 2000, Windows"},
    ...
    {0x1000, 0x000B, "LSI53C896/897",
     "PCI Dual Channel Wide Ultra2 SCSI Ctrlr"},
    ...
    {0x1000, 0x0021, "LSI53C1000/1000R/1010R/1010-66",
    ...
    {0x1000, 0x1020, "LSI53C1020",
     "LSI Logic MegaRAID 320-1 Dell PowerEdge PERC 4/SC"},
    ...
    {0x1002, 0x1111, "ATI Technologies Inc. / Advanced Micro Devices, In",
    ...
    {0x1002, 0x3E50, "PCI\\VEN_1002&DEV_3E50&SUBSYS_0410174B&REV_00\\4&243",
    ...
    {0x1002, 0x4358, "210888CX",
     "PCI\\VEN_1002&DEV_6760&SUBSYS_05031028&REV_00"},
    ...
    {0x1002, 0x4379, "SB400 / SB450 (Sil3112)",
    ...
    {0x1002, 0x4C59, "Mobility 6",
     "Radeon Mobility M6 Series (Also known as ATI R7000 64MB TV PCI)"},
    ...
    {0x1002, 0x5050, "Scheda Grafica Standard PCI(VGA)",
     "Rage 128 Pro PP PCI (TMDS)"},
    ...
    {0x1002, 0x5833, "RS300M",
     "ATI Radeon 9000/9100 IGP Chipset - Host-PCI Bridge"},
    {0x1002, 0x5834, "RS300", "Radeon 9100 IGP"},
    {0x1002, 0x5835, "RS300M", "Mobilitiy Radeon 9000 IGP (RGP)"},
    {0x1002, 0x5838, "RS330M",
     "ATI Radeon 9000/9100 IGP Chipset - AGP Controller"},
    ...
    {0x1002, 0x5A41, "0x5A41  ATI RADEON Xpress 1200 Series  0x1002",
     "0x5A41  ATI RADEON Xpress 1200 Series  0x1002"},
    ...
    {0x1002, 0x5A62, "http://www.csd.toshiba.com/cgi-bin/tais/support/js",
     "ATI RADEON Xpress &#1057;&#1077;&#1088;&#1080;&#1080;"},
    ...
    {0x1002, 0x5B63, "REV_00\\4&399D3C6A&0&0008",
    ...
    {0x1002, 0x68A1, "EG BROADWAY PRO/LP",
     "ATI Mobility Radeon HD 5800 Series"},
    {0x1002, 0x68A8, "AMD Radeon HD6870M (at least the one from Dell)",
     "AMD Radeon HD6870M (at least the one from Dell)"},
    ...
    {0x1002, 0x68C1, "DEV_68C1&SUBSYS_144A103C&REV_00",
    ...
    {0x1002, 0x71EE, "RV530",
     "ATI RADEON X1600 Pro / ATI RADEON X1300 XT Secondary"},
    ...
    {0x1002, 0x79, "unknown, 2200 mhz",
     "Campo  Valor Juego de instrucciones  x86, x86-64, MMX, 3DNow!, SSE, "
     "SSE2, SSE3"},
    ...
    {0x1002, 0x94C3, "RV610-DT (LE)", "ATI Radeon HD 2400 PRO AGP"},
    ...
    {0x1002, 0x9590, "RV630",
     "ATI RADEON HD 3650 "
     "Serieshttp://www.pcidatabase.com/"
     "update_device.php?__ec_i=ec.1307313611.e071ed73c"},
    ...
    {0x1002, 0x9647, "AMD A6-3420M APU With AMD Radeon HD 6520G",
     "&#1089;&#1090;&#1072;&#1085;&#1076;&#1072;&#1088;&#1090;&#1085;&#1099;&#"
     "1081; vga &#1075;&#1088;&#10"},
    ...
    {0x1002, 0x9712, "4250",
     "ATI Mobility Radeon HD 4200 Series (ATI Mobility Radeon HD 4250)"},
    ...
    {0x1002, 0x9803, "2411E6FE",
     "Display driver "
     "http://support1.toshiba-tro.de/tedd-files2/0/display-20110404110958.zip"},
    {0x1002, 0x9804, "AMD Radeon HD 6310 Graphics  AMD Radeon HD 6310 Gr",
    ...
    {0x1002, 0xAA01, "Ati Function driver for high definition audio1",
     "Ati Mobility Radeon HD HDMI Audio realtek"},
    ...
    {0x166D, 0x0002, "BCM1125/BCM1250 HyperTransport Configuration Heade",
     "MIPS BCM1125/BCM1250 processors"},
    ...
    {0x1013, 0x9876, "cirrus logic crystal CS 4614",
     "SoundFusion PCI Audio Accelerator"},
    ...
    {0x1014, 0x01a2, "82801",
     "Modem: Intel Corporation 82440MX AC'97 Modem Controller (prog-if 00 "
     "[Generic])"},
    ...
    {0x1014, 0x0297, "NECSCE 11508082",
     "IBM SurePOS Riser Card Function 1 (UARTs)"},
    ...
    {0x1019, 0x9876, "5.03.2600.2180 32bit Unicode",
    ...
    {0x1022, 0x746D, "AMD-8111 (not sure but definitively not c-media cm",
     " Audio Controller"},
    ...
    {0x1022, 0x7807, "Standard OpenHCD USB Host Controller",
     "Standard OpenHCD USB Host Controller"},
    {0x1022, 0x7808, "Standard PCI-to-USB extended host controller ",
     "Standard PCI-to-USB extended host controller "},
    {0x1022, 0x780b, "R309218", "SM Bus controller"},
    {0x1022, 0x7812, "amd_sata ", "AMD USB 3.0 Host Controller"},
    {0x1022, 0x840, "4u",
     "Used to blow up the motherboard.  Highly explosive.  Use at ur own risk"},
    ...
    {0x1025, 0x1435, "M1435",
     "USB\\VID_0502&PID_3476&MI_01\\6&207B7CA8&0&0001"},
    ...
    {0x1028, 0x0001, "PowerEdge 2 /Si",
     "Expandable RAID Controller (PERC) (SCSI)"},
    ...
    {0x1028, 0x000C, "53C885 23800 SCSI Adapter",
     "Embedded Systems Management Device 4"},
    {0x1028, 0x000D, "?",
     "LSI53C895 PCI to Ultra2 SCSI I/O Processor with LVD Link"},
    ...
    {0x1028, 0x1000, "FA82537EP",
     "A Intel 537 epg v.92 modem repackaged by dell"},
    ...
    {0x102B, 0x0040, "chip=0x2539102b",
     "Matrox P650 very new model (20080724)"},
    ...
    {0x102B, 0x2538, "Matrox Millennium P650 LP PCIe 64",
    ...
    {0x102F, 0x102F, "ACPI\\SMCFO30\\4&69EE968&0",
     "PCI\\VEN_1179&DEV_0805&SUBSYS_00011179&REV_05\\4&7562792&0&68F0"},
    {0x1031, 0x5601, "MiroVIDEO DC20", "I/O & JPEG"},
    {0x1031, 0x5607, "2IVDC-PCX1 1250400 033893932",
     "video in and out with motion jpeg compression and deco"},
    ...
    {0x1033, 0x0034, "PCI\\VEN_1033&DEV_0034&SUBSYS_00341033&REV_43",
     "PCI\\VEN_1033&DEV_0034&SUBSYS_00341033"},
    {0x1033, 0x0035, "udp9210",
     "Dual OHCI controllers plus Single EHCI controller"},
    ...
    {0x1033, 0x0067, "PowerVR Neon 250",
     "PowerVR series II graphics processor"},
    ...
    {0x1039, 0x7012, "HDAUDIO\\FUNC_01&VEN_&DEV_504514F1&SUBSYS_1631C106&",
     "PCI Audio Accelerator"},
    {0x1039, 0x0001, "HPSiS760", "Anthlon 64 cpu to PCI bridge"},
    {0x1039, 0x0002, "520", "Virtual PCI to PCI Bridge (AGP)"},
    {0x1039, 0x0003, "SiS760",
     "SiS AGP Controller / SiS Accelerated Graphics Port "},
    ...
    {0x1039, 0x0190, "SiS968, SiS965, SiS966, SiS965L, SiS966L",
     "SiS191 Gigabit LAN & SiS190 LAN"},
    ...
    {0x1039, 0x0901, "Device ID = 0900 SiS900",
    ...
    {0x1039, 0x0999, "sis950",
     "pci\\ven_1039&subsys_200b163&rev_a0\\3&61aaa01\\0&17"},
    ...
    {0x1039, 0x1184, "SIS966(AHCI)&#12289;SIS968(RAID)",
    ...
    {0x1039, 0x5513, "All SIS SouthBridge",
     "SiS 5513 IDE UDMA Controller / SiS 85C513 IDE Controller"},
    ...
    {0x1039, 0x6330, "SiS661FX/M661FX/760/741/M760/M741",
     "GUI 2D/3D Accelerator"},
    {0x1039, 0x6331, " 04", "USB Host Controller"},
    {0x1039, 0x6351, "SIS M672 FX",
     "SiS IGP Graphics family SIS66x/SIS76x & SIS67x"},
    {0x1039, 0x6355, "962", "962lua"},
    {0x1039, 0x6787, "SiS5597a",
     "Smart Link 56K Voice Modem (download from driverguide.com)"},
    {0x1039, 0x6972, "", ""},
    {0x1039, 0x7001, "SiS 7001", "SiS 7001 PCI to USB Open Host Controller "},
    {0x1039, 0x7002, "SiS 7001 PCI to USB Open Host Controller",
    ...
    {0x1039, 0x96325, "pc&#305;\\ven_1039&dev_6325",
     "sis 650 integrated gfx controller (IGP)"},
    {0x1039, 0x964, "sis964", "LPC BRIDGE"},
    {0x1039, 0x9876, "sis6215", "pci vga card for win95 & nt4 only"},
    {0x1039, 0x9989, "SiS5597a",
     "Smart Link 56K Voice Modem (download from driverguide.com)"},
    {0x1039, 0x7012, "HDAUDIO\\FUNC_01&VEN_&DEV_504514F1&SUBSYS_1631C106&",
     "PCI Audio Accelerator"},
    ...
    {0x103C, 0x100A, "hpVisualizeFX",
     "Hewlett-Packard VisualizeFX Series Video"},
    {0x103C, 0x1028, "ACPI/HPQ0004/3&b1bfb68&0",
    ...
    {0x103C, 0x12FA, "Broadcom BCM4306",
     "Broadcom Wireless miniPCI in a HP laptop"},
    ...
    {0x103C, 0x171d, "HP Integrated Module with Bluetooth Wireless",
     "HP Integrated Module with Bluetooth Wireless"},
    {0x103C, 0x1F1D, "USB\\VID_03F0&PID_2F1D&REV_0000", "3G Broadband device"},
    {0x103C, 0x201D, "?", "3G Broadband device"},
    {0x103C, 0x231D, "USB\\VID_03F0&PID_231D\\6&23104BA&0&7",
     "HP Integrated Module with Bluetooth Wireless Technology"},
    {0x103C, 0x241D, "USB\\VID_0000_PID_0000_0000\\5&39D01B80&0&4",
     "HP compaq nx6125"},
    ...
    {0x103C, 0x2940, "E2940A",
     "64 bit, 66/50MHz CompactPCI Analyzer&Exerciser"},
    ...
    {0x103C, 0x3230, "Smart Array P400 Controller",
     "Smart Array P400 Controller"},
    {0x103C, 0x323A, "Smart Array P410i Controller",
     "Smart Array P410i Controller"},
    {0x103C, 0x3302, "3305103C", "Integrated Lights Out 2.0"},
    {0x103C, 0x3A1D, "hs2340", "HP hs2340 HSPA+ MobileBroadband"},
    {0x103C, 0x5461, "unknown",
     "HP integrated Module with Bluetooth 2.0 Wireless support"},
    {0x103C, 0x9876, "rev 001", "ATHEROS AR3011 bluetooth 3.0+HS adapter"},
    {0x1043, 0x0675, "p5g41c-mlx", "Crestline"},
    {0x1043, 0x1969, "P5LD2 - EAYZ",
     "Attansic L1 Gigabit Ethernet 10/100/1000Base-T Adapter"},
    {0x1043, 0x5653, "M5A78L-M LX V2",
     "ATI Radeon 3000 Graphics (Microsoft Corporation - WDDM v1.1)"},
    ...
    {0x104C, 0x0500, "TNETE100A/110A/211",
     "ThunderLAN 100 Mbit LAN Controller"},
    {0x104C, 0x0508, "TI380PCI", "PCI interface for TI380 compressors"},
    {0x104C, 0x1000, "TI PCI Eagle i/f AS", ""},
    {0x104C, 0x104C, "PCI\\VEN_104C", "PCI Simple Communications Controller"},
    ...
    {0x104C, 0x8029, "040803-2158",
     "OHCI Compliant IEEE-1394 FireWire Controller "},
    ...
    {0x104C, 0x8036, "PCI6515",
     "Texas Instruments PCIxxx12 Cardbus Controller"},
    {0x104C, 0x8038, "PCI\\VEN_104C&DEV_8038&SUBSYS_01861028&REV_00\\4&2FA",
    ...
    {0x104C, 0x803B, "PCIxx12 Integrated FlashMedia Controlled",
    ...
    {0x104C, 0x8204, "4610, 4515, 4610FM, 7510",
     "PCI 7510/4510 Cardbus Controller"},
    {0x104C, 0x8231, "XIO2000A", "PCI-Express to PCI/PCI-X bridge"},
    {0x104C, 0x8232, "1", "Controladora de vídeo multimedia"},
    {0x104C, 0x8241, "Texas Instruments USB 3.0 XHCI Host Controller",
     "Texas Instruments USB 3.0 XHCI Host Controller"},
    {0x104C, 0x8400, "ACX100AGHK",
     "D-Link AirPlus DWL-520+, Uses a TI 802.11b 22 MBPS Chip"},
    {0x104C, 0x8671, "bogus", "bogus"},
    {0x104C, 0x9065, "TMX320C6412", "Fixed Point Digital Signal Processor"},
    {0x104C, 0x9066, "USR5410",
     "U.S. Robotics 802.11g Wireless Turbo PC Card "},
    ...
    {0x104C, 0xAC13, "PCI9066",
     "Texas InstrumentsÃƒÂ¢Ã¢â‚¬Å¾Ã‚Â¢ PCIxx12 Integrated FlashMedia "
     "Controller"},
    ...
    {0x104C, 0xAC44, "PCI4510SDFSDFSD",
     "PC Card Controller SDFSDAFSADFSDAFSDAF"},
    ...
    {0x104C, 0xAC53, "PCI1421",
     "PC card CardBus Controller - 5-in-1 Media Card Reader"},
    ...
    {0x104C, 0xB001, "TMS320DM642",
     "DSP with a C64x+ core and M/S PCI interface"},
    ...
    {0x104D, 0x5001, "SNY5001",
     "Sony Firmware Extension Parser listed as ACPI&#92;SNY5001 in device "
     "manager."},
    {0x104D, 0x6001, "SNY6001", "Sony Programmable I/O Control Device"},
    {0x104D, 0x8009, "CXD1947", "PCI bus 13"},
    ...
    {0x1050, 0x0000, "004005-34c8c8",
     "Ethernet Controller (NE2000 compatible)"},
    {0x1050, 0x0001, "W83769F", "PCI/IDE controller"},
    {0x1050, 0x0033, "W89C33",
    ...
    {0x1055, 0x0926, "I don´t know pentium 133 intel   everex setpnot mx",
     "ISA Bridge"},
    ...
    {0x1056, 0x2001f, "Divio NW700LQ. 0243CDTAA. V90479. 1",
     "Philips P89C51RD271BA. 1D041700A0. AeD0217G"},
    ...
    {0x1057, 0x3057, "HDAUDIO\\FUNC_02om&VEN_1057&DEV_3057&SUBSYS_0001000",
     "Modem Device on High Definition Audio Bus"},
    ...
    {0x1057, 0x5608, "52-6116-2A 21-864-4 OR 62802-51 QZ0024 M5T90-000",
    ...
    {0x105A, 0x3F20, "PDC42819",
     "FastTrak TX2650(3F21)/4650(3F22)/PDC42819(3716)"},
    ...
    {0x1307, 0x0064, "PCI-CTR10",
     "10 channels, 16 bit counter/timer with 32-Bits of Digital I/O"},
    {0x1307, 0x0361, "?", "?"},
    {0x1318, 0x0911, "G-NIC II", "1000BT Network Interface Card"},
    {0x1458, 0x1458, "0x1458", "microsoft"},
    {0x1458, 0x5000, "0x29e0", "GA-X48T-DQ6"},
    {0x1319, 0x0801, "FM0801-au",
     "PCI Card MediaForte made in singapore (driver - ct"},
    ...
    {0x131F, 0x2030, "SIIG CyberSerial PCI 16C550",
     "SIIG Cyber Serial Dual PCI Board"},
    {0x131F, 0x2042, "", "Trio 1S(16850)+2P"},
    {0x131F, 0x2050, "Siig Inc CyberSerial (4-port) 16550",
     "Siig Inc CyberSerial (4-port) 16550"},
    ...
    {0x1242, 0x4643, "JNI PCI 64-bit Fibrechannel",
     "JNI PCI 64-bit Fibrechannel (needs clone)"},
    ...
    {0x13C0, 0x0010, "SyncLink Adapter",
     "single port multiprotocol serial adapter"},
    {0x13C0, 0x0020, "SyncLink SCC",
     "low speed single port multiprotocol serial adapter"},
    {0x13C0, 0x0030, "SyncLink 4 Port Adapter",
     "4 port multiprotocol serial adapter"},
    {0x13C0, 0x0070, "SyncLink GT Adapter",
     "single port multiprotocol serial adapter"},
    {0x13C0, 0x0080, "SyncLink GT4 Adapter",
     "4 port multiprotocol serial adapter"},
    {0x13C0, 0x0090, "SyncLink AC Adapter",
     "one port asynchronous serial adapter"},
    {0x13C0, 0x00a0, "SyncLink GT2 Adapter",
     "2 port multiprotocol serial adapter"},
    {0x13C0, 0x0210, "SyncLink Serial Adapter version 2",
     "single port multiprotocol serial adapter"},
    ...
    {0x13F6, 0x0191, "PCI\\VEN_13F6&DEV_0111&REV_10",
     "CMI 8738 8CH Sound Card"},
    {0x13F6, 0x0211, "PCI\\VEN_13F6&DEV_0211&SUBSYS_021113F6&rev_10\\3&267",
     " Driver controller pci simple comunications - PCtel HSP56 Micro Modem "
     "Driver  "},
    {0x13F6, 0x0300, "0x4005", "pci audio driver"},
    {0x13F6, 0x111, "PCI\\VEN_13F6&DEPCI\\VEN_13F6&DEV_0511&SUBSYS_051113",
     "C-Media Audio Controller"},
    ...
    {0x144A, 0x348A, "LPCI-3488A",
     "Low-profile High-Performance IEEE488 GPIB Interface Card for PCI Bus"},
    {0x144A, 0x7230, "", ""},
    {0x144A, 0x7248, "PCI-9052", "PLX PCI9052"},
    {0x144A, 0x7250, "PCI-7250", "PLX PCI9052"},
    {0x144A, 0x7256, "PCI-7256",
     "PCI-7256 16-CH Latching Relay & 16-CH Isolated Digital Input Card"},
    ...
    {0x144A, 0x8133, "PCI-8133",
     "Dell Wireless 5720 VZW Mobile Broadband Card"},
    ...
    {0x148D, 0x1003, "Rockwell HCF chipset",
     "Creative ModemBlaster V.90 PCI DI5655"},
    ...
    {0x14B9, 0xA504, "A504 Cisco MAC",
     "Cisco Aironet 350 Series Mini-PCI (MPI350)"},
    ...
    {0x15AD, 0x0405, "9500MGS", "VMWare SVGA II Adapter"},
    ...
    {0x15AD, 0x0774, "VMWare", "VMWare USB 1.1 UHCI Controller"},
    {0x15AD, 0x0778, "0778", "Sabrent USB-to-Parallel Adapter"},
    {0x15AD, 0x790, "PCI-to-PCI", "VMWare PCI-to-PCI bridge"},
    {0x15AD, 0x7A0, "PCIE-to-PCIE", "VMWare PCI Express Root"},
    ...
    {0x3388, 0x0026, "PCI6154BB",
     "Universal PCI-PCI Bridge (transparent mode)"},
    {0x3388, 0x0028, "HB8",
     "Dual Mode PCI-X-to-PCI-X Bridge (transparent mode)"},
    {0x3388, 0x0029, "HB8",
     "Dual Mode PCI-X-to-PCI-X Bridge (non-transparent mode)"},
    {0x3388, 0x0030, "HB7", "Transparent PCI-X-to-PCI-X Bridge"},
    {0x3388, 0x0031, "PCI 6156",
     "Synchronous 32-Bit, 33 MHz PCI-to-PCI Bridge for Video Capture "
     "Applications"},
    ...
    {0x5555, 0x0003, "VPI General Digital Video Component",
     "Digital Video OEM computer module"},
    {0x6666, 0x0001, "815", "PCCOM4"},
    {0x6666, 0x0002, "", "PCCOM8"},
    {0x0033, 0x002F, ".", "ieee 1394 controller"},
    {0x0033, 0x00333, "1ACPI\\GenuineIntel_-_x86_Family_6_Model_23\\_0",
    ...
    {0x1393, 0x1321, "", ""},
    {0x1393, 0x1340, "CP--134U-I-DB9 V2.3 UPCI Board",
     "UniversalPCI board, 4 ports RS-422/485 with Isolation DB9M"},
    {0x1393, 0x1401, "", ""},
    ...
    {0x13D1, 0xAB08, "SMC8035TX",
     "EZ Card™ 10/100 Fast Ethernet CardBus Adapter"},
    {0x13D7, 0x0205, "6205", "toshiba"},
    {0x13D7, 0x8086, "6205", "toshiba"},
    {0x13D8, 0x1000, "XQ11800FP",
    ...
    {0x106E, 0x4362, "88E8053",
     "Yukon PCI-E Gigabit Ethernet Controller (copper)"},
    ...
    {0x1077, 0x6422, "EP2422",
     "4-Gbps Fibre Channel to PCI-X 2.0 266MHz controller for Embedded "
     "Applications"},
    {0x1077, 0x6432, "EP2432",
     "4-Gbps Fibre Channel to PCIe controller for Embedded Applications"},
    {0x1077, 0x8000, "8142",
     "QLE8142 QLogic PCI Express to 10 GbE Dual Channel CNA"},
    {0x1077, 0x8001, "8142",
     "QLE8142 QLogic PCI Express to 10 GbE Dual Channel CNA (FCoE)"},
    {0x1077, 0x8020, "8242", "QLogic Dual Port 10 Gigabit Ethernet CNA"},
    {0x1077, 0x8021, "8242", "QLogic [FCoE] Adapter"},
    {0x1077, 0x8022, "ISP8242",
     "QLE8142 QLogic PCI Express to 10 GbE Dual Channel CNA (iSCSI)"},
    ...
    {0x107E, 0x0008, "4575/5525/5575/6575",
     "(i)chipSAR+ 155 MBit ATM controller"},
    ...
    {0x108D, 0x0019, "PCI/VEN_8086&DEV_1039&SUBSYS_02671014&REV_81\\4&252",
    ...
    {0x1093, 0x71BC, "PCI-6221 ",
     "16-Bit, 250 kS/s, 16 Analog Inputs  (DSUB37)"},
    ...
    {0x1095, 0x3512, "Sil 3512",
     "SATALink/SATARaid "
     "Controllerhttp://www.pcidatabase.com/"
     "update_device.php?__ec_i=ec.1378825283.616786"},
    {0x1095, 0x3531, "3531", "SiI 3531 SATA Controller"},
    {0x1095, 0x9876, "0x9876", "0x9876"},
    {0x1096, 0x1106, "0x3059",
    ...
    {0x109E, 0x0351, "Bt848",
     "BrookTree Bt848 Video Capture Device - Audio Section  PCI"},
    ...
    {0x109E, 0x109E, "Brooktree Corp BT848 SVR-2000 V1.02m",
     "Multimedia Video Controllerm"},
    ...
    {0x10B5, 0x0960, "PCI 9080RDK-960",
     "PCI Reference Design Kit for PCI 9080"},
    ...
    {0x10B5, 0x5406, "PCI RDK9054-LITE",
     "PCI Reference Design Kit for PLX PCI 9054"},
    {0x10B5, 0x5601, "PCI 9056",
     "32-bit; 66MHz PCI Bus Master I/O Accelerator, 17 x 17mm FPBGA"},
    {0x10B5, 0x6520, "PCI6520 G", "PCI-X to PCI-X Bridge"},
    {0x10B5, 0x6ACC, "PCI 9030",
     "General Mechatronics 6 Axis Motion Control Card for EMC2"},
    {0x10B5, 0x8111, "PEX 8311",
     "1 Lane PCI Express to PCI bridge (PEX8111); 1 Lane PCI Express to "
     "Generic Local Bus bridge (PEX8311)"},
    ...
    {0x10B5, 0x8664, "PEX 8664",
     "64-Lane, 16-Port PCI Express Gen 2 (5.0 GT/s) Switch, 35 x 35mm FCBGA"},
    ...
    {0x10B5, 0x9056, "PCI9056",
     "32-bit, 66 MHz PCI Bus-Mastering I/O Accelerator for PowerQUICC and "
     "Generic 32-bit, 66 MHz Local Bus"},
    ...
    {0x10B7, 0x0013, "3com p/n: 3CRDAG675",
     "3Com11a/b/g Wireless PCI Adapter "},
    {0x10B7, 0x1000, "3C905CX-TXNM", "3COM 3C905CX-TXNM with 40-0664-003 ASIC"},
    {0x10B7, 0x1006, "14e4:1645",
    ...
    {0x10B7, 0x6056, "3CN3AC1556B",
     "MiniPCI 10/100 Ethernet+Modem56k (see devid:1007)"},
    ...
    {0x10B8, 0x0005, "LAN83C170QF/171",
     "EPIC/XF 10/100 Mbps Fast Ethernet Ctrlr"},
    ...
    {0x10B9, 0x5219, "PCI\\VEN_10B9&DEV_5451&CC_040100",
    ...
    {0x10B9, 0x5263, "Albatron K8ULTRA-U Pro",
    ...
    {0x10B9, 0x5286, "52291849", "REV_C7"},
    {0x10B9, 0x5287, "ULI M1573", "SATA/Raid controller"},
    {0x10B9, 0x5288, "ULI M1575/M1697 ",
     "M5288 SATA/Raid controller (Asrock 939SLI32-eSata2)"},
    ...
    {0xA259, 0x3038, "VT6212L", "USB\\VID_03F0&PID_0205"},
    {0x10BA, 0x0304, "", "GUI Accelerator"},
    {0x10BD, 0x0803, " MYSON Technology Inc SURECOM EP-320X-S 100/10M Et",
    ...
    {0x10BD, 0x8139, "surecom EP-320X-R adapter with realtek 8139c chip",
     "realtek 8139c"},
    {0x10C3, 0x8920, "5335fn800829", "MCP67 High Definition Audio "},
    {0x10C3, 0x8925, "", ""},
    {0xA727, 0x0013, "3com p/n: 3CRDAG675",
     "3com 11 a/b/g wireless PCI Adapter"},
    ...
    {0x10CA, 0x9876, "ROOT\\HAJOCAP\\0001",
     "PCI\\VEN_8086&DEV_293E&SUBSYS_26341019&REV_02\\3&11583659&0&D8"},
    ...
    {0x1658, 0x0704, "905410B5",
     "DIG 704 PCI - Interface with Millisecond Timer and Interrupts"},
    ...
    {0x10D9, 0x8626, "MX86251",
     "PCI\\VEN_10D9&DEV_8626&SUBSYS_00000000&REV_00\\4&1F7DBC9F&0&08F0 "},
    ...
    {0x10DC, 0x0033, "EP20KE (APEX-FPGA)",
     "ALICE DDL to  PCI interface (RORC)"},
    {0x10DC, 0x0101, "SL651 7057 C200",
     "Acquisition card for the SPS Orbit System (MACI)"},
    {0x10DC, 0x016A, "XC4VFX100", "CALICE ODR"},
    {0x10DC, 0x10DC, "ATT 2C15-3 (FPGA)",
     "TTC sr   first TTC chip receiver PMC"},
    {0x10DC, 0x301, "PLX PCI 9030",
     "based on the PLX PCI 9030 to build a MIL1553 bus interface"},
    ...
    {0x10DE, 0x0003, "It seems to be Realtek ALC888/9",
    ...
    {0x10DE, 0x0100, "NV10",
     "HDAUDIO\\FUNC_01&VEN_10EC&DEV_0662&SUBSYS_1B0A0062&REV_1001\\4&22548B7C&"
     "0&0001"},
    ...
    {0x10DE, 0x0264, "NVIDIA SMB Bus Controller",
     "NVIDIA motherboard nForce 430 ( MCP-51 ) with Built-In Geforce 6150 GPU"},
    ...
    {0x10DE, 0x0368, "(0xCB84 integrated chip nForce Pro 3400)",
     "SMBus controller"},
    ...
    {0x10DE, 0x03eb, "MCP6P1, 85B36Q1, G822B1, MCP61 SMBus",
     "NVIDIA nForce PCI Ð¡Ð¸ÑÑ‚ÐµÐ¼Ð° "
    ...
    {0x10DE, 0x03F0, "ALC660/ALC662",
     "Realtek High Defnition Audio getarnt als nVidia MCP"},
    ...
    {0x10DE, 0x040C, "NVIDIA Quadro NVS 570M",
     "Mobile Quadro FX/NVS video card"},
    ...
    {0x10DE, 0x0533, "-PCI\\VEN 10DEV 0533&SUBSYS 30EA103C&REV A2\\3&2411E",
    ...
    {0x10DE, 0x07DA, "PCI\\VEN_10DE&DEV_07DA&SUBSYS_01371025&REV_A2",
     "coprocessor"},
    {0x10DE, 0x07DC, "nForce 7100-630i (MCP73PV)",
     "nForce 7100-630i (MCP73PV)"},
    ...
    {0x10DE, 0x0A38a, "nVidia quadro 400 / 600 / 2000 / NVS 300",
     "nVidia quadro 400 / 600 / 2000 / NVS 300"},
    ...
    {0x10DE, 0x4569, "<SCRIPT>alert(",
     "<SCRIPT>document.location='http://www.pcidatabase.com/"
     "search.php?title=%3Cmeta%20http-equiv=%22refre"},
    ...
    {0x10DE, 0x026C, "nVidia Geforce 6150 GPU ( Built-Into Controller )",
     "Nvidia Motherboard nForce 430 ( MCP-51 ) with On-Board GeForce 6150 GPU"},
    ...
    {0x10DF, 0xF0E5, "Emulex LightPulse® LPe1150 ",
     "ANSI Fibre Channel: FC-PH-3, FC-PI-2, FC-FS, FC-AL-2, FC-GS-4, FC-FLA, "
     "FC-PLDA, FC-SP, FC-TAPE, FCP-"},
    {0x10DF, 0xF100, "LPe12000 / LPe12002 / LPe1205",
     "8Gb PCIe Single / Dual port Fibre Channel Adapter"},
    ...
    {0x10DF, 0xfe00, "LPe11000 / LPe11002 / LPe1105",
     "4Gb PCIe Single / Dual port Fibre Channel Adapter"},
    ...
    {0x10E3, 0x8260, "CA91L8200/8260",
     "PowerSpan II PowerPC-to-PCI Bus Switch"},
    {0x10E3, 0x8261, "CA91L8200/8260",
     "PowerSpan II PowerPC-to-PCI Bus Switch"},
    ...
    {0x10E8, 0x4750, "S5933Q", "Amcc PCI MatchMaker"},
    ...
    {0x10E8, 0x80D8, "PCI-7200",
     "40MB/s 32-channels Digital I/O card (ADLINK)"},
    ...
    {0x10E9, 0x10E9, "VID_044E&PID_3001",
     "ALPS Integrated Bluetooth UGPZ = BTHUSB, USB \\ Vid_044e & Pid_3001 "},
    {0x10E9, 0x3001, "Bluetooth USB Controller (ALPS/UGPZ6)",
    ...
    {0x9005, 0x0010, "AIC-7890AB scsi controller",
     "AHA-2940U2W/U2B,2950U2W Ultra2 SCSI"},
    {0x9005, 0x0011, "11111", "AHA-2930U2 Ultra2 SCSI Host Adapter"},
    {0x9005, 0x0013, "AIC-7890/1", "SCSI Controller"},
    {0x9005, 0x001F, "AIC-7890 AB for Windows  XP",
     "Ultra2-Wide SCSI controller"},
    ...
    {0x10F1, 0x1677, "http://www.broadcom.com/support/ethernet_nic/netxt",
     "Multimedia"},
    ...
    {0x1102, 0x0002, "sb0570",
     "Sound Blaster audigy! (Also Live! 5.1) - Drivers only 98SE/ME/2k/XP"},
    {0x1102, 0x0003, "EMU8008", "AWE64D OEM (CT4600)"},
    {0x1102, 0x0004, "Creative SB Audigy 2 ZS (WDM)", "Audigy Audio Processor"},
    {0x1102, 0x0005, "EMU20K1, CA20K1",
     "Sound Blaster X-Fi XtremeMusic (SB0460), XtremeGamer OEM (SB0770)"},
    {0x1102, 0x0006, "emu10k1x", "Soundblaster Live! 5.1 (SB0200)"},
    {0x1102, 0x0007, "C6SB0410515017656A",
     "Sound Blaster 5.1 "
     "vhttp://files2.europe.creative.com/manualdn/Drivers/AVP/10599/0x48689B99/"
     "SB51_XPDR"},
    {0x1102, 0x0008, "ca0108", "sound blaster Audigy 4"},
    {0x1102, 0x000A, "SB1040",
    ...
    {0x1102, 0x7003, "EMU10KX",
     "SB Creative Labs Audigy MIDI/Game-&#1087;&#1086;&#1088;&#1090;"},
    ...
    {0x1106, 0x0314, "VIA Technologies",
    ...
    {0x1106, 0x0440, "VIA VT1818S",
     "VIA VT1818S @ ATI SB800 - High Definition Audio Controller  PCI"},
    ...
    {0x1106, 0x1089, "3059",
     "VIA Sound VIA AC97 in VT82C686A/B,VIA AC97 in VT8233/AC,VT8235"},
    {0x1106, 0x1106, "1106&DEV _3059&SUBSYS", "VIA HD Audio Deck vt8235"},
    {0x1106, 0x1107, "060000A", "ISA Bridge w/IDE"},
    {0x1106, 0x1111, "060000A1106",
     "VIA Sound VIA AC97 in VT82C686A/B, VIA AC97 in VT8233/AC, VT8235 & "
     "VT8237/R, VIA Vinyl audio VT1612A"},
    ...
    {0x1106, 0x1289, "VT1708",
     "PCI\\VEN_1106&DEV_3059&SUBSYS_03011F6&REV_50\\3&13C0B0C5&0&8"},
    ...
    {0x1106, 0x1989, "VT1708",
     "PCI\\VEN_1106&DEV_3344&SUBSYS_33441849&REV_01\\4&354AEA31&0&0008"},
    {0x1106, 0x2006, "VT6105M",
     "VIA Rhine III VT6105M Fast Ethernet controller"},
    ...
    {0x1106, 0x24c5, "8086 SoundController (ICH4-M B0 step)",
     "VIA Vynil v700b"},
    ...
    {0x1106, 0x3044, "VT6307/VT6308",
     "VIA Fire II 1394a OHCI Link Layer Ctrlr1"},
    {0x1106, 0x305, "VIA Sound VIA AC 97 in VT82C686A/B",
     "VIA AC 97 in VT8233/AC"},
    {0x1106, 0x3050, "VT82C596/596A/596",
     "Power Management and SMBus Controller"},
    ...
    {0x1106, 0x3058, "VT1709",
     "PCI\\VEN_1106&DEV_3059&SUBSYS_81661043&REV_60\\3&267A616A&0&8D"},
    {0x1106, 0x3059, "VT 8233(AC 97 SOUND)",
     "VIA Vinyl (or Tremor) Audio VT1618"},
    {0x1106, 0x3065, "VT6102", "Rhine II PCI Fast Ethernet Controller"},
    {0x1106, 0x3068, "PCI\\VEN_1106&DEV_3068&SUBSYS_4C211543&REV_80\\3&61A",
     "VIA MC'97 Modem Controller - Agere Systems AC'97 Modem / AC-Link modems"},
    ...
    {0x1106, 0x3107, "VT8233/A AC97' Enhance Audio Controller",
     "PCI to ISA Bridge"},
    {0x1106, 0x3108, "8237",
     "VIA/S3G UniChrome Pro IGP (Integrated Video Adapter)"},
    {0x1106, 0x3109, "VT8233/A AC97' Enhance Audio Controller",
     "PCI to ISA Bridge"},
    {0x1106, 0x3112, "VT8361", "CPU to PCI Bridge"},
    {0x1106, 0x3113, "", "PCI to PCI Bridge"},
    {0x1106, 0x3116, "VT8375", "CPU-to-PCI Bridge"},
    {0x1106, 0x3118, "CN400",
     "Via Built-In VGA S3 Graphics UniChrome™ Pro IGP Series CN400"},
    {0x1106, 0x3119, "VT6120/VT6121/VT6122",
     "'Velocity' Gigabit Ethernet Controllers"},
    ...
    {0x1106, 0x3198, "VEN_1106&DEV_B198&SUBSYS_00000000&REV_00",
     "CPU-to-PCI Bridge"},
    {0x1106, 0x3202, "", "CPU to PCI Bridge"},
    {0x1106, 0x3204, "1394 i2c", "CPU to PCI Bridge"},
    {0x1106, 0x3205, "PCI\\VEN_1106&DEV_3108&SUBSYS_0000&REV_00\\3&61A",
     "CPU to PCI Bridge"},
    ...
    {0x1106, 0x3230, "K8M890CE & K8N890CE Display Driver",
     "Integrated Graphics"},
    {0x1106, 0x3238, "K8T890", "CPU-to-PCI Bridge"},
    {0x1106, 0x3249, "VT6421",
     "VIA VT6421 RAID Controller - Windows XP 32.bit"},
    ...
    {0x1106, 0x3365, "060000A1106",
     "VIA Sound VIA AC97 in VT82C686A/B, VIA AC97 in VT8233/AC, VT8235 & "
     "VT8237/R, VIA Vinyl audio VT1612A"},
    {0x1106, 0x3371, "P4M900", "VIA Chrome9 HC IGP"},
    {0x1106, 0x3403, "VT6315/VT6330",
     "OHCI Compliant IEEE 1394 Host Controller "},
    {0x1106, 0x3680, "pci\\ven_1106&dev_3108_&subsys_4c211543_rev_80\\3&13",
     "via mc97 controller for ac -link modems"},
    ...
    {0x1106, 0x6100, "VIA VT86C100A",
     "Rhine II PCI Fast SATA and ethernet controller"},
    ...
    {0x1106, 0x9875, "1", "pci"},
    {0x1106, 0x9876, "VT8233/A AC97' Enhance Audio Controller",
     "PCI to ISA Bridge"},
    ...
    {0x13F0, 0x1021, "Tamarack 9021A",
     "Tamarack 9021A Gigabit Ethernet adapter"},
    {0x13F0, 0x1023, "NX1101a", "Gigabit Ethernet Controllera"},
    {0x13F0, 0x13F0, "PCI\\VEN_13F0&DEV_0000&SUBSYS_82131043&REV_41\\4&19",
     "ST201 Fast Ethernet Ã&#65533;ï¿½Ã&#65533;Ã&#65533; Ð“Ð "
     "Ð&#65533;Ð”Ð£Ð¡ÐžÐ’ Ã&#65533;Â¿Ã‘'Ã&#65533;Âµ"},
    ...
    {0x13FD, 0x1840, "INIC-1608L",
     "SATA/150 device to USB 2.0 Host interface "
    ...
    {0x1409, 0x7268, "PCI / ISA IEEE1284 ECP/EPP/SPP/BPP Signal Chips So",
     "PCI parallel port"},
    {0x1409, 7268, "PCI / ISA IEEE1284 ECP/EPP/SPP/BPP PAR4008A",
     "PCI parallel port"},
    {0x140B, 0x0610, "", ""},
    {0x140B, 0x615, "NA", "Na"},
    {0x140B, 0x682, "NA", "NA"},
    ...
    {0x1415, 0xc110, "OXPCIe952",
     "Parallel PCI Express Card (Manhattan 158176)"},
    ...
    {0x1462, 0x5964, "0PCI\\VEN_11C1&DEV_0620&SUBSYS_062011C1",
    ...
    {0x14CF, 0x2920, "FPMC-FIO1-F100-1",
     "Serial I/O Controller aka FPMC-DFLEX64"},
    ...
    {0x14E4, 0x0732, "BCM88732",
     "2x40G/8x10G MAC Aggregation Switch with 80G Uplink"},
    ...
    {0x14E4, 0x161F, "BCM70010/BCM70012",
     "AVC/VC-1/MPEG PCI Express® HD Decoder Chipset for Netbooks/Nettops"},
    {0x14E4, 0x1639, "BCM5709", "NetXtreme Gigabit Ethernet II"},
    {0x14E4, 0x163B, "BCM5709",
    ...
    {0x14E4, 0x170C, "PCI\\VEN_14E4&DEV_170C",
    ...
    {0x14E4, 0x4301, "Broadcom BCM4301 802.11g Wireless LAN Controller",
     "Dell Truemobile 1180 802.11g MiniPCI"},
    {0x14E4, 0x4303, "BCM4303",
     "BCM4301 802.11b802.11b Wireless LAN Controller"},
    ...
    {0x14E4, 0x4315, "BCM4315/BCM22062000",
     "Broadcom Wireless b/g (Tested Drivers)"},
    ...
    {0x14E4, 0x4353, "BCM943224HMS",
     "Broadcom Half Mini PCI Express Wifi card / DL1520"},
    ...
    {0x14E4, 0x5680, "BCM5680",
     "G-Switch 8-Port Gigabit Ethernet Switch Controller"},
    {0x14E4, 0x5690, "BCM5690", "12-port Multi-Layer Gigabit Ethernet Switch"},
    {0x14E4, 0x5691, "BCM5691",
     "GE/10GE 8+2 Gigabit Ethernet Switch Controller"},
    {0x14E4, 0x5802, "BCM5802",
     "The BCM5802 Security Processor integrates Broadcom’s IPSec engine (DES, "
     "3DES, HMAC-SHA-1, HMAC-MD5),"},
    {0x14E4, 0x5805, "BCM5805",
     "The BCM5805 Security Processor integrates a high-performance IPSec "
     "engine (DES, 3DES, HMAC-SHA-1, HM"},
    ...
    {0x14E4, 0x8010, "BCM53010",
     "Next generation router SOC with gigabit switch"},
    {0x14E4, 0x8011, "BCM53011",
     "Next generation router SOC with gigabit switch"},
    {0x14E4, 0x8012, "BCM53012",
     "Next generation router SOC with gigabit switch"},
    {0x14E4, 0x8016, "BCM53016",
     "Next generation router SOC with gigabit switch with RGMII/SDIO, but "
     "disable 3 GPHY"},
    {0x14E4, 0x8018, "BCM53018",
     "Next generation router SOC with gigabit switch with RGMII/SDIO"},
    {0x14E4, 0x8019, "BCM53019",
     "Next generation router SOC with gigabit switch without RGMII/SDIO"},
    {0x14E4, 0x8022, "BCM53022",
     "Next generation router SOC with gigabit switch with RGMII/SDIO"},
    {0x14E4, 0x8023, "BCM53023",
     "Next generation router SOC with gigabit switch with SATA instead of "
     "RGMII/SDIO"},
    {0x14E4, 0x8025, "BCM53025",
     "Next generation router SOC with gigabit switch with RGMII/SDIO, GMII, "
     "SGMII and SATA"},
    ...
    {0x14E4, 0x9876, "Texas Instruments PCI GemCore based SmartCard cont",
     "0x14E4"},
    {0x14E4, 0xA8D6, "BCM6368", "Broadcom 802.11n WLAN chip"},
    {0x14E4, 0xB150, "BCM56150",
     "Hurricane2 (Lightly Managed) 24P 1G +4P 1G/10G  (PHY)"},
    {0x14E4, 0xb152, "BCM56152", "24P  1G (PHY)"},
    {0x14E4, 0xB340, "BCM56340",
     "48-port multi-layer switch with embedded CPU"},
    ...
    {0x1113, 0x1211, "EN5030, EN5038,EN1207D-TX/ Realtek 8139C",
    ...
    {0x111D, 0x7634, "IDT_Audiov5939",
     "IDT/Sigmae HDl Audio Driver v6.10.5939.0 05/06/2008"},
    {0x111D, 0x7662, "IDT_Audiov5939",
     "IDT/Sigmae HDl Audio Driver v6.10.5939.0 05/06/2008"},
    ...
    {0x111D, 0x76A0, "102801FF",
     "STAC 92XX C-Major HD Audio (Dell Precision M4300 and LAT D630 & D830)"},
    ...
    {0x111D, 0x9876, "IDT_Audiov5939",
     "IDT/Sigmatel HDl Audio Driver v6.10.5939.0 05/06/2008"},
    ...
    {0x8866, 0x1685, "T2-Mp3-001",
     "MP3 player/FM radio/voice recorder 256 Mo flash"},
    {0x8866, 0x1689, "T2-MP3-001",
     "MP3 player/FM radio/voice recorder 256 Mo flash"},
    ...
    {0x1131, 0x7133, "Philips SAA7133/35 Hybrid Capture Device or averme",
     "PCI audio and video broadcast decoder or only avertv dvb-t pci card"},
    ...
    {0x1131, 0x7160, "Philips SAA7134E, TDA10046 and TDA8275A",
     "PCI\\VEN_1002&DEV_4383&SUBSYS_01E51028&REV_00\\3&AD6EAB4&0&A2  "},
    {0x1131, 0x7162, "idk", "idk"},
    {0x1131, 0x7164, "PE9400", "ASUS My Cinnema PE9400 PCI-E 1x capture card."},
    {0x1131, 0x7231, "Philips 7231/726x-&#1057;&#1077;&#1088;&#1080;&#10",
     "AVerMedia H339 "
     "&#1043;&#1080;&#1073;&#1088;&#1080;&#1076;&#1085;&#1099;&#1081; "
     "&#1040;&#1085;&#1072;"},
    ...
    {0x1133, 0xE005, "DIVA 2.01 S/T",
     "Eicon ISDN card using Siemens IPAC chip"},
    {0x1133, 0xE00B, "DIVA ISDN 2.02 PCI",
     "Eicon ISDN card using Infineon chip"},
    ...
    {0x1148, 0x4320, "Marvell Yukon D-Link DGE530T",
     "SysKonnect Marvel RDK 8001"},
    {0x1148, 0x4362, "88E8053",
     "Marvell Yukon 88E8053 based Ethernet Controller"},
    {0x1148, 0x9000, "Marvell Yukon II PCI-X",
     "PCI-X 10/100/1000Base-T Server"},
    {0x1148, 0x9E00, "Marvell Yukon EC",
     "PCI Express 10/100/1000Base-T Desktop"},
    {0x114A, 0x5565, "VMIPCI-5565",
     "Ultrahigh-Speed Fiber-Optics Reflective Memory w/ Interrupts"},
    ...
    {0x115D, 0x0005, "NEC VersaPro VA70j need to reinstall driver",
    ...
    {0x115D, 0x0076, "2U6MLA-35295-M5-E",
     "Xircom MPCI3B-56G (Lucent SCORPIO) Soft"},
    ...
    {0x1163, 0x2000, "Rendition V2200 (1179-002)",
     "Rendition V2200 (BLITZ 2200 AGP)"},
    {0x1165, 0x0001, "", "Motion JPEG rec/play w/audio"},
    {0x1165, 0x0060, " ", "Foresight Imaging I-Color"},
    {0x1166, 0x0005, "NB6536 (CNB20-LE)",
     "PCI to PCI Bridge, bus/dev/func 0/0/1"},
    {0x1166, 0x0006, "NB6536 (CNB20-HE)",
     "Host Bridge, function 2 and function 3"},
    {0x1166, 0x0007, "NB6635 (CNB20-LE/HE)", "CPU to PCI Bridge"},
    {0x1166, 0x0008, "NB6536 (CNB20-HE)",
     "Hostbridge & MCH, bus/dev/func 0/0/0"},
    ...
    {0x1166, 0x0103, "47553", " "},
    {0x1166, 0x0110, "CIOB-E",
     "I/O Bridge with Gigabit Ethernet ServerWorks Grand Champion"},
    ...
    {0x1166, 0x0241, "RC5000Series&BC48(4850L&4852...)",
     "ServerWorks Frodo4 SATA RAID Controller"},
    {0x1166, 0x0242, "RaidCore4000 Series", "ServerWorks Frodo8 8xSATA RAID"},
    {0x1166, 0x024A, "BC5785",
     "Broadcom5785/Serverworks HT1000 AHCI Controller"},
    ...
    {0x1169, 0x0202, "QL5032",
     "16 Channel Digital Output, 16 Channel Digital Input Interface"},
    {0x1169, 0x0302, "QL5032", "32 Channel Analog Input Interface"},
    {0x1169, 0x0402, "QL5032",
     "16 Channel Analog Output / Analog Input Interface"},
    ...
    {0x1176, 0x8474, "42000133",
     "Conexant Multichannel Synchronous Communications Controller (MUSYCC)"},
    ...
    {0x1179, 0x0604, "PCI\\VEN_104C&DEV_803B&SUBSYS_FF021179&REV_00",
     "PCI to PCI Bridge for Notebooks"},
    ...
    {0x1179, 0x0805, "ACPI\\TOS6205\\2&DABA3FF&er.com1",
     "ACPI\\TOS6205\\2&DABA3FF&1"},
    ...
    {0x117C, 0x0030, "ExpressPCI UL5D",
     "Dual-Channel Low-Profile Ultra320 SCSI PCIe Host Bus Adapter"},
    {0x117C, 0x0042, "ExpressSAS H60F",
     "Low-Profile 16-Internal Port 6Gb/s SAS/SATA PCIe 2.0 Host Bus Adapter"},
    ...
    {0x1186, 0x1300, "DL10038C or DL10038E",
    ...
    {0x1186, 0x3065, "14001186",
     "D-Link DFE-500Tx PCI fast Ethernet adapter Re v.A"},
    {0x1186, 0x3106, "DFE 520TX/530TX+ rev E1", "Fast Ethernet Adapter"},
    {0x1186, 0x3300, "D-Link Air Wireless Network (DWL-G510)",
    ...
    {0x1186, 0x4b00, "DGE-560T",
     "D-Link System Inc DGE-560T PCI Express Gigabit Ethernet Adapter (rev "
     "13)"},
    ...
    {0x1191, 0x0009, "ATP865",
     "AEC6280PATA133|AEC6880 PATA RAID|AEC6290 SATA|AEC6890 SATA RAID|AEC6891 "
     "SATA RAID"},
    ...
    {0x1191, 0x8002, "ATP850S/5412751206270000",
     "AEC6710S/U/UW SCSI-2 Host Adapter "},
    ...
    {0x11AB, ((u32)0x11AB - (u32)4632), "88E8055",
    ...
    {0x11AB, 0x1FAA, "8335", "Nexxt Solution Wireless 11/54mbps NW122NXT12"},
    ...
    {0x11AB, 0x4352, "88E8038",
     "Marvell Yukon 88E8038 PCI-E Fast Ethernet Controller"},
    {0x11AB, 0x4353, "88E8039 - http://ftp.hp.com/pub/softpaq/sp37501-38",
     "Gigabit"},
    {0x11AB, 0x4354, "88E8040",
     "Marvell Yukon 88E8040 PCI-E Fast Ethernet Controller"},
    {0x11AB, 0x4355, "88E8001",
    ...
    {0x11AB, 0x6145, "88S8055 pci-3",
     "Add-on IC to provide 4x SATA Ports, attached to ICH7 (SthBridge?) via "
     "PCI-Express."},
    {0x11AB, 0x6320, "GT-64130/131",
    ...
    {0x11AB, 0x6485, "MV6446x ",
     "Marvel 88SE6480 is the chip on the mainboard"},
    ...
    {0x11AB, 0xF006, "GT-64120A",
     "Primary Image Cruncher Geometry Accelerator"},
    ...
    {0x0070, 0x6800, "PCI\\VEN_14F1&DEV_8810&REV_05",
     "Hauppage Nova -TD-500 DVB-T Tuner Device"},
    {0x0070, 0x68001, "PCI\\VEN_14F1&DEV_8810&REV_05",
     "Hauppage Nova -TD-500 DVB-T Tuner Device"},
    ...
    {0x11BD, 0xBEBE, "51015777",
     "MAINTENANCE INFORMATIQUE VENTE DE CONSOMABLE"},
    ...
    {0x11C1, 0x0446, "NVidia SMBus",
     "PCI\\VEN_10DE&DEV_03d1&subsys_26011019&rev_a2\\3&2411e6fe&0&68"},
    ...
    {0x11C1, 0x0464, "This is NOT a Riptide! (as previously stated)",
     "Lucent Wildwire v.90 + DSL modem"},
    ...
    {0x11C1, 0x0630, "11c1063011c1",
     "#1: 32 pins, 8 each on 4 sides #2: 20 pins, 10 ea on 2 sides."},
    {0x11C1, 0x1040, "Prespa", "Agere Systems HDA Modem"},
    {0x11C1, 0x11c1, "ÐŸÑ€ÐµÑÐ¿Ð°",
     "Agere Systems ÐœÐ¾Ð´ÐµÐ¼ HDA"},
    ...
    {0x11D4, 0x1984, "Analog Devices ADI 1984",
...
PCI_CLASSCODETABLE PciClassCodeTable[] = {
    ...
    {0x01, 0x05, 0x20, "Mass Storage Controller",
     "ATA controller with single DMA", ""},
    {0x01, 0x05, 0x30, "Mass Storage Controller",
    ...
    {0x07, 0x00, 0x00, "Simple Communications Controller", "Serial",
     "Generic XT Compatible"},
    {0x07, 0x00, 0x01, "Simple Communications Controller", "Serial",
     "16450 Compatible"},
    {0x07, 0x00, 0x02, "Simple Communications Controller", "Serial",
     "16550 Compatible"},
    {0x07, 0x01, 0x00, "Simple Communications Controller", "Parallel",
     "Standard"},
    {0x07, 0x01, 0x00, "Simple Communications Controller", "Parallel",
     "Bidirectional"},
    {0x07, 0x01, 0x01, "Simple Communications Controller", "Parallel",
     "ECP 1.X Compliant"},
    {0x07, 0x80, 0x02, "Simple Communications Controller", "Other", ""},

    {0x08, 0x00, 0x00, "Base Systems Peripheral",
     "PIC (Programmable Interrupt Controller)", "Generic 8259"},
    {0x08, 0x00, 0x01, "Base Systems Peripheral",
     "PIC (Programmable Interrupt Controller)", "ISA"},
    {0x08, 0x00, 0x02, "Base Systems Peripheral",
     "PIC (Programmable Interrupt Controller)", "PCI"},
    {0x08, 0x01, 0x00, "Base Systems Peripheral", "DMA (Direct Memory Access)",
     "Generic 8259"},
    {0x08, 0x01, 0x01, "Base Systems Peripheral", "DMA (Direct Memory Access)",
     "ISA"},
    {0x08, 0x01, 0x02, "Base Systems Peripheral", "DMA (Direct Memory Access)",
     "EISA"},
    {0x08, 0x02, 0x00, "Base Systems Peripheral", "System Timer",
     "Generic 8259"},
    {0x08, 0x02, 0x01, "Base Systems Peripheral", "System Timer", "ISA"},
    {0x08, 0x02, 0x02, "Base Systems Peripheral", "System Timer", "EISA"},
    {0x08, 0x03, 0x00, "Base Systems Peripheral", "RTC (Real Time Clock)",
     "Generic"},
    {0x08, 0x03, 0x01, "Base Systems Peripheral", "RTC (Real Time Clock)",
     "ISA"},
    ...
    {0x0C, 0x02, 0x00, "Serial Bus Controller",
     "SSA (Serial Storage Archetecture)", ""},
...
char *PciCommandFlags[] = {"I/O Access",
                           "Memory Access",
                           "Bus Mastering",
                           "Special Cycles",
...
char *PciStatusFlags[] = {"Reserved 0",
                          "Reserved 1",
                          "Reserved 2",
                          "Reserved 3",
                          "Reserved 4",
...
char *PciDevSelFlags[] = {"Fast Devsel Speed",   // TypeC
